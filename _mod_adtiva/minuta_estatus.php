...
$customTransaction->registerTrigger("END", "Trigger_Default_Redirect", 99, "minuta_list.php");
// Set custom transaction SQL
$customTransaction->setSQL("UPDATE contrato_minuta  SET contrato_minuta.ctrl = {GET.ctrl} WHERE contrato_minuta.Id = {GET.Id}");
// Add columns
