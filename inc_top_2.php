...
$restrict->addLevel("7");
$restrict->addLevel("8");
$restrict->addLevel("11");
$restrict->addLevel("12");
$restrict->addLevel("13");
$restrict->addLevel("14");
$restrict->Execute();
...
$logoutTransaction->registerTrigger("END", "Trigger_Default_Redirect", 99, "../../GestionInfSup/index.php");
// Add columns
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td height="77"><img src="../../Athena/Logo.png" width="299" height="59" /></td>
  </tr>
  <tr>
...
<li><a href="#">INFORMES DE SUPERVISI&Oacute;N</a>
  <ul>
    <?php do { ?>
...
?><a href="<?php echo $logoutTransaction->getLogoutLink(); ?>">Cerrar sesi&oacute;n</a></li>
</ul>
</li>
</ul>
