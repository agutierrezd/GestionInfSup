...
$colnamep_rsq1vsq2 = "-1";
if (isset($_GET['rpais'])) {
  $colnamep_rsq1vsq2 = $_GET['rpais'];
}
mysql_select_db($database_oConnPPSYV, $oConnPPSYV);
mysql_set_charset('utf8',$oConnPPSYV);
$query_rsq1vsq2 = sprintf("SELECT * FROM q_ranking_ano WHERE reg_ano = %s and pbl_pais = %s ORDER BY promedio DESC", GetSQLValueString($colname_rsq1vsq2, "date"),GetSQLValueString($colnamep_rsq1vsq2, "int"));
