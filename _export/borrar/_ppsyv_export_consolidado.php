...
$query_rsRZones = sprintf("SELECT * FROM q_ranking_region WHERE reg_ano = %s  AND q_ranking_region.PERIODO = %s", GetSQLValueString($colano_rsRZones, "text"),GetSQLValueString($colper_rsRZones, "int"));
...
$colname_rspbl = "-1";
if (isset($_GET['periodo'])) {
  $colname_rspbl = $_GET['periodo'];
}
$colano_rspbl = "-1";
if (isset($_GET['yearr'])) {
  $colano_rspbl = $_GET['yearr'];
}
mysql_select_db($database_oConnPPSYV, $oConnPPSYV);
mysql_set_charset('utf8',$oConnPPSYV);
$query_rspbl = sprintf("SELECT * FROM q WHERE q.PERIODO = %s AND q.reg_ano = %s ORDER BY PROMTOTAL DESC", GetSQLValueString($colname_rspbl, "int"),GetSQLValueString($colano_rspbl, "int"));
...
// Defining List Recordset variable
$colano_rsRZonesTrim = "-1";
if (isset($_GET['yearr'])) {
  $colano_rsRZonesTrim = $_GET['yearr'];
}
$colname_rsRZonesTrim = "-1";
if (isset($_GET['periodo'])) {
  $colname_rsRZonesTrim = $_GET['periodo'];
...
mysql_select_db($database_oConnPPSYV, $oConnPPSYV);
mysql_set_charset('utf8',$oConnPPSYV);
$query_rsRZonesTrim = sprintf("SELECT * FROM q_resultado_ppsyv_area WHERE trimestre = %s AND q_resultado_ppsyv_area.reg_ano = %s ORDER BY PROMTOTAL DESC", GetSQLValueString($colname_rsRZonesTrim, "int"),GetSQLValueString($colano_rsRZonesTrim, "int"));
...
$objPHPExcel->getActiveSheet()->duplicateStyleArray($title, 'A2:I2');
$objPHPExcel->getActiveSheet()->setCellValue('A2', 'Id')->getColumnDimension('A')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('B2', utf8_encode('Región'))->getColumnDimension('A')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('C2', utf8_encode('País'))->getColumnDimension('B')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('D2', utf8_encode('Cant. PBLS'))->getColumnDimension('C')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('E2', utf8_encode('Cámara Escondida (40%)'));
$objPHPExcel->getActiveSheet()->setCellValue('F2', utf8_encode('Evaluación V.S. (20%)'));
$objPHPExcel->getActiveSheet()->setCellValue('G2', 'Sondeo Clientes (20%)');
$objPHPExcel->getActiveSheet()->setCellValue('H2', 'Imagen REX (20%)');
$objPHPExcel->getActiveSheet()->setCellValue('I2', 'Total (100%)');
...
$objPHPExcel->getActiveSheet()->setCellValue('B'.$xlsRow, 'ANDEAN')->getStyle('B2:B'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('C'.$xlsRow, $row_rsRZones['region_name'])->getStyle('B2:B'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('D'.$xlsRow, $row_rsRZones['REGIONQ'])->getStyle('C2:C'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('E'.$xlsRow, $row_rsRZones['PROMCE'])->getStyle('D2:D'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('F'.$xlsRow, $row_rsRZones['PROMEVS'])->getStyle('E2:E'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('G'.$xlsRow, $row_rsRZones['PROMSC'])->getStyle('F2:F'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('H'.$xlsRow, $row_rsRZones['PROMREX'])->getStyle('G2:G'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$objPHPExcel->getActiveSheet()->setCellValue('I'.$xlsRow, $row_rsRZones['PROMTOTAL'])->getStyle('H2:H'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$objPHPExcel->getActiveSheet()->setCellValue('B2', utf8_encode('Área'))->getColumnDimension('B')->setAutoSize(true);
$objPHPExcel->getActiveSheet()->setCellValue('C2', utf8_encode('Cámara Escondida(40%)'));
$objPHPExcel->getActiveSheet()->setCellValue('D2', utf8_encode('Evaluación V.S. (20%)'));
$objPHPExcel->getActiveSheet()->setCellValue('E2', 'Sondeo Clientes (20%)');
$objPHPExcel->getActiveSheet()->setCellValue('F2', 'Imagen REX (20%)');
