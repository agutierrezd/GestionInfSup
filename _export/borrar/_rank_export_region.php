...
$objPHPExcel->getActiveSheet()->setCellValue('C1', 'CANTIDAD PBLS  ')->getColumnDimension('C')->setAutoSize(true);
...
$objPHPExcel->getActiveSheet()->duplicateStyleArray($title3, 'H2:H'.$xlsRow);
...
// Rename sheet
$objPHPExcel->getActiveSheet()->setTitle('Ranking andean');
...
header('Content-Disposition: attachment;filename='.$vQualifier.'_Ranking_Andean.xls');
