...
$query_rsq1vsq2 = "SELECT rank_periodo3.pbl, ppsyv_pbl.pbl_name, ppsyv_pbl.pbl_ciudad, ppsyv_pbl.pbl_dealer, ppsyv_pbl.pbl_tm_user AS TM, ppsyv_pbl.pbl_pais, ppsyv_region_pais.pais_name AS PAIS, rank_periodo3.rank AS RANKQ1, rank_periodo3.valor AS VALORQ1, rank_periodo4.rank AS RANKQ2, rank_periodo4.valor AS VALORQ2, (rank_periodo3.rank - rank_periodo4.rank) AS QCOMPARA, IF(rank_periodo4.rank > rank_periodo3.rank, 'arrow_down.png',IF(rank_periodo4.rank < rank_periodo3.rank,'arrow_up.png','arrow_right.png')) AS QIMG, IF(rank_periodo4.rank > rank_periodo3.rank, 'FF0000',IF(rank_periodo4.rank < rank_periodo3.rank,'336600','FFFF00')) AS QCOLOR, IF(rank_periodo4.rank > rank_periodo3.rank, 'FFFFFF',IF(rank_periodo4.rank < rank_periodo3.rank,'FFFFFF','000000')) AS QFUENTE FROM rank_periodo3 INNER JOIN rank_periodo4 ON rank_periodo3.pbl = rank_periodo4.pbl INNER JOIN ppsyv_pbl ON rank_periodo3.pbl = ppsyv_pbl.idpbl INNER JOIN ppsyv_region_pais ON ppsyv_pbl.pbl_pais = ppsyv_region_pais.idpais ORDER BY rank_periodo4.rank , rank_periodo3.rank ";
...
$objPHPExcel->getActiveSheet()->setCellValue('A1', 'COMPARACION DE PERIODO 4 Vs PERIODO 3');
...
$objPHPExcel->getActiveSheet()->setCellValue('H2', 'PUESTO PERIODO 4');
$objPHPExcel->getActiveSheet()->setCellValue('I2', 'PUNTAJE PERIODO 4');
$objPHPExcel->getActiveSheet()->setCellValue('J2', 'PUESTO PERIODO 3');
$objPHPExcel->getActiveSheet()->setCellValue('K2', 'PUNTAJE PERIODO 3');
$objPHPExcel->getActiveSheet()->setCellValue('L2', 'Q4 Vs Q3');
...
// Rename sheet
$objPHPExcel->getActiveSheet()->setTitle('Q4_VS_Q3');
...
header('Content-Disposition: attachment;filename=Q4_VS_Q3.xls');
