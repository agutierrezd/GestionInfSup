...
$query_Recordset1 = sprintf("SELECT * FROM ppsyv_tab_sc WHERE sc_pbl_fk = %s", GetSQLValueString($colname_Recordset1, "int"));
...
$vQualifier = $row_Recordset1['sc_pbl_fk'];
...
$objPHPExcel->getActiveSheet()->setCellValue('D1', 'Hora');
$objPHPExcel->getActiveSheet()->setCellValue('E1', 'Vendedor');
$objPHPExcel->getActiveSheet()->setCellValue('F1', 'Encuesta #');
$objPHPExcel->getActiveSheet()->setCellValue('G1', 'Confianza');
$objPHPExcel->getActiveSheet()->setCellValue('H1', 'Amigable');
$objPHPExcel->getActiveSheet()->setCellValue('I1', 'Rapidez');
$objPHPExcel->getActiveSheet()->setCellValue('J1', 'comentarios');
$objPHPExcel->getActiveSheet()->setCellValue('K1', 'Cliente habitual');
...
$objPHPExcel->getActiveSheet()->setCellValue('B'.$xlsRow, $row_Recordset1['sc_pbl_fk']);
$objPHPExcel->getActiveSheet()->setCellValue('C'.$xlsRow, $row_Recordset1['sc_countcycle']);
$objPHPExcel->getActiveSheet()->setCellValue('D'.$xlsRow, $row_Recordset1['sc_hora']);
$objPHPExcel->getActiveSheet()->setCellValue('E'.$xlsRow, $row_Recordset1['sc_namevendedor']);
$objPHPExcel->getActiveSheet()->setCellValue('F'.$xlsRow, $row_Recordset1['sc_numencuesta']);
$objPHPExcel->getActiveSheet()->setCellValue('G'.$xlsRow, $row_Recordset1['sc_01']);
$objPHPExcel->getActiveSheet()->setCellValue('H'.$xlsRow, $row_Recordset1['sc_02']);
$objPHPExcel->getActiveSheet()->setCellValue('I'.$xlsRow, $row_Recordset1['sc_03']);
$objPHPExcel->getActiveSheet()->setCellValue('J'.$xlsRow, $row_Recordset1['sc_comments']);
$objPHPExcel->getActiveSheet()->setCellValue('K'.$xlsRow, $row_Recordset1['sc_clientehabitual']);
$objPHPExcel->getActiveSheet()->setCellValue('L'.$xlsRow, $row_Recordset1['sc_cycle']);
...
header('Content-Disposition: attachment;filename='.$vQualifier.'_PPSYV_SC.xls"');
