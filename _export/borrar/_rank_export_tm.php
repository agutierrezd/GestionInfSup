...
$query_rspbl = sprintf("SELECT * FROM q_ranking_tm2 WHERE cycle_ms_tri = %s AND reg_ano = %s ORDER BY TOTALRANK DESC ", GetSQLValueString($nameper_rspbl, "text"),GetSQLValueString($colano_rspbl, "text"));
