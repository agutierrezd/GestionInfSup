...
$query_rsprocess = ("SELECT * FROM q_pn_master WHERE idarancel = $subpartida AND FechaVencimiento BETWEEN '$desde' AND '$hasta' ORDER BY FechaVencimiento ASC");
...
header('Content-Disposition: attachment;filename="reporte_003.xlsx"');
