...
$query_rsprocess = ("SELECT * FROM q_pn_master WHERE FechaVencimiento BETWEEN '$desde' AND '$hasta' ORDER BY FechaVencimiento ASC");
...
$objPHPExcel->getActiveSheet()->setCellValue('A1', 'REGISTRO DE PRODUCTORES NACIONALES RANGO DE ' . $_POST['from'] . ' A ' . $_POST['to']);
...
header('Content-Disposition: attachment;filename="reporte_002.xlsx"');
