...
$objPHPExcel->getActiveSheet()->setCellValue('D'.$xlsRow, number_format($row_rspagos['ctrlpagos_valor'],2,',','.'))->getStyle('D7:D'.$xlsRow)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
