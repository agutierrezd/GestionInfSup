...
$objPHPExcel->getActiveSheet()->setCellValue('A4', utf8_encode('SUPERVISOR: '.$row_rssupervisor['usr_name'].' '.$row_rssupervisor['usr_lname'].'  NOMBRE/RAZON: '.$row_rssupervisor['contractor_name']));
$objPHPExcel->getActiveSheet()->setCellValue('A5', utf8_encode('VALOR: '.number_format($row_rsinfocontrato['VALORI'],2,',','.').'  PAGADO: '.number_format($row_rscontrolpagado['valorpagado'],2,',','.').'  SALDO: '.number_format(($row_rsinfocontrato['VALORI']-$row_rscontrolpagado['valorpagado']),2,',','.')));
