...
$query_rsprocess = ("SELECT * FROM q_pn_master_cap WHERE cap BETWEEN '$capi' AND '$capf' ORDER BY FechaVencimiento ASC");
...
$objPHPExcel->getActiveSheet()->setCellValue('A1', 'REGISTRO DE PRODUCTORES NACIONALES');
...
$objPHPExcel->getActiveSheet()->setCellValue('L'.$xlsRow, $row_rsprocess['estado']);
