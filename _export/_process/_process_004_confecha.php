...
$query_rsprocess = ("SELECT * FROM q_pn_master_cap WHERE cap BETWEEN '$capi' AND '$capf' AND FechaVencimiento BETWEEN '$desde' AND '$hasta' ORDER BY FechaVencimiento ASC");
...
$objPHPExcel->getActiveSheet()->setCellValue('A1', 'REGISTRO DE PRODUCTORES NACIONALES RANGO DE ' . $_POST['froma'] . ' A ' . $_POST['toa']);
...
$objPHPExcel->getActiveSheet()->setCellValue('K'.$xlsRow, $row_rsprocess['estado']);
...
header('Content-Disposition: attachment;filename="reporte_004.xlsx"');
