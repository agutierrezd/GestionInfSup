...
$customTransaction->registerTrigger("END", "Trigger_Default_Redirect", 99, "a_docs_soporte_311.php?as_id={GET.as_id}&doclasedoc_id={GET.doclasedoc_id}&anio_id={GET.anio_id}&hash_id={GET.hash_id}");
// Set custom transaction SQL
$customTransaction->setSQL("UPDATE almovconsdia SET almovconsdia.mcd_valmovto = ((almovconsdia.mcd_cantmovto * almovconsdia.mcd_valunitant)* almovconsdia.mcd_tax)\nWHERE doclasedoc_id_fk = {GET.doclasedoc_id}");
// Add columns
