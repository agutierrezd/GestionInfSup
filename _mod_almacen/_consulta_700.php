...
$query_rsbusca = sprintf("SELECT * FROM q_inventario_central_700 WHERE midnroplaca LIKE %s", GetSQLValueString("%" . $colname_rsbusca . "%", "text"));
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><form action="_consulta_700.php" method="get" name="form1" id="form1">
...
?>
  <table width="100%" border="0" cellspacing="2" cellpadding="0">
    ...
    <?php do { ?>
      <tr>
        <td class="frmtablabody"><span class="titlemsg2"><?php echo $row_rsbusca['midnroplaca']; ?><br />
        </span>    <span class="titlenormaltextbold">Serie:<?php echo $row_rsbusca['midnroserie']; ?></span></td>
        ...
        <td class="frmtablabody"><table width="90%" border="0" cellspacing="2" cellpadding="0">
            <tr>
              ...
              <td width="81%" class="frmtablabody"><?php echo $row_rsbusca['midfuncionario']; ?></td>
            </tr>
        </table></td>
        <td class="frmtablabody"><table width="200" border="0" cellspacing="2" cellpadding="0">
          <tr>
            <td width="41%" class="frmtablahead">Cuenta:</td>
            <td width="59%" class="frmtablabody"><?php echo $row_rsbusca['midcuenta']; ?></td>
          </tr>
          <tr>
            <td class="frmtablahead">Elemento:</td>
            <td class="frmtablabody"><?php echo $row_rsbusca['midcodelem']; ?></td>
          </tr>
          <tr>
            <td class="frmtablahead">Almac&eacute;n:</td>
            <td class="frmtablabody"><?php echo $row_rsbusca['midalmacen']; ?></td>
          </tr>
        </table>        </td>
        <td class="frmtablabody"><p><?php echo $row_rsbusca['midfechadoc']; ?><br />
        </p>        </td>
        <td class="frmtablabody" align="right"><?php echo number_format($row_rsbusca['mid_valormovto'],0,',','.'); ?></td>
