...
$query_rsdocvinc = sprintf("SELECT * FROM q_almacen_600_700 WHERE sys_doclasedoc_id_fk = %s AND  {$NXTFilter_rsdocvinc}  ORDER BY  {$NXTSort_rsdocvinc} ", GetSQLValueString($colname_rsdocvinc, "int"));
...
?>
            <table width="150" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center"><a href="../_gendraft/htmltodocx/_comp_egreso_dev.php?doclasedoc_id=<?php echo $row_rsinfogendocumentos['doclasedoc_id']; ?>&amp;numdocumento=<?php echo $row_rsinfousuario['func_doc']; ?>"><img src="321_gencomp.png" width="32" height="32" border="0" /></a></td>
      ...
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        ...
        <tbody>
          ...
          <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
            ...
            <td><div class="titlemsg3Gray"><?php echo KT_FormatForList($row_rsdocvinc['midnroplaca'], 20); ?>
              <?php 
// Show IF Conditional region8 
if (@$_SESSION['kt_login_level'] == 8) {
?>
                <a href="w_legaliza.php?almovinddia_id=<?php echo $row_rsdocvinc['almovinddia_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Vincular placa al inventario global"><img src="324_add.png" width="32" height="32" border="0" /></a>
                <?php } 
