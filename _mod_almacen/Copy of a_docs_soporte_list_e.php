      ...
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        <thead>
          <tr class="KT_row_order">
            ...
            <th id="do_nrodoc" class="KT_sorter KT_col_do_nrodoc <?php echo $tso_listrslistdocssoporte1->getSortIcon('do_nrodoc'); ?>"> <a href="<?php echo $tso_listrslistdocssoporte1->getSortLink('do_nrodoc'); ?>">N�MERO DOCUMENTO</a> </th>
