...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><a href="a_docs_soporte_310.php?as_id=<?php echo $_GET['as_id']; ?>&amp;doclasedoc_id=<?php echo $_GET['doclasedoc_id']; ?>&amp;anio_id=<?php echo $_GET['anio_id']; ?>&amp;hash_id=<?php echo $_GET['hash_id']; ?>&amp;lnk=<?php echo $_GET['lnk']; ?>&amp;numdocumento=<?php echo $_GET['numdocumento']; ?>">REGRESAR</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
      <tr>
        ...
        <td class="frmtablahead">ASIGNAR CANTIDAD</td>
      </tr>
      <?php do { ?>
        <tr>
          <td class="frmtablabody" align="center"><?php echo $row_rsdestalle['mcd_cantmovto']; ?></td>
          <td class="frmtablabody" align="center"><?php echo $row_rsdestalle['mcdalmacen']; ?></td>
          ...
          <td class="frmtablabody" align="center"><a href="a_docs_soporte_310_xinsert.php?almovconsdia_id=<?php echo $row_rsdestalle['almovconsdia_id']; ?>&amp;numdocumento=<?php echo $_GET['numdocumento']; ?>&amp;doclasedoc_id=<?php echo $_GET['doclasedoc_id']; ?>&amp;q=<?php echo $row_rsdestalle['mcd_saldant']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )">
            <?php 
// Show IF Conditional region1 
if (@$row_rsdestalle['mcd_saldant'] > 0) {
?>
              <img src="Add_326.png" width="32" height="32" border="0" />
            <?php } 
