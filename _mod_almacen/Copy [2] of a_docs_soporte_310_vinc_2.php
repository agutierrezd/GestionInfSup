    ...
    <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
      ...
      <?php do { ?>
        <tr>
          ...
          <td class="frmtablabody" align="center"><a href="a_docs_soporte_310_xinsert.php?almovconsdia_id=<?php echo $row_rsdestalle['almovconsdia_id']; ?>&amp;numdocumento=<?php echo $_GET['numdocumento']; ?>&amp;doclasedoc_id=<?php echo $_GET['doclasedoc_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )">
            <?php 
