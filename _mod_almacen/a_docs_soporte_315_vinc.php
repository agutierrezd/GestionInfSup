...
$query_rsfindplaca = sprintf("SELECT * FROM q_almacen_600_700 WHERE midnroplaca LIKE %s AND  {$NXTFilter_rsfindplaca}  ORDER BY  {$NXTSort_rsfindplaca} ", GetSQLValueString("%" . $colname_rsfindplaca . "%", "text"));
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="80%" border="0" align="center" cellpadding="0" cellspacing="3">
      <tr>
        <td><form id="form2" name="form2" method="get" action="a_docs_soporte_315_vinc.php?as_id=<?php echo $_GET['as_id']; ?>&amp;doclasedoc_id=<?php echo $row_rsinfogendocumentos['doclasedoc_id']; ?>&amp;anio_id=<?php echo $_GET['anio_id']; ?>&amp;hash_id=<?php echo $_GET['hash_id']; ?>&amp;lnk=<?php echo $_GET['lnk']; ?>&amp;numdocumento=<?php echo $_GET['numdocumento']; ?>">
          ...
          <?php if ($totalRows_rsfindplaca > 0) { // Show if recordset not empty ?>
            <?php do { ?>
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                <td align="center"><a href="transact_placa_vincula.php?as_id=<?php echo $_GET['as_id']; ?>&amp;doclasedoc_id=<?php echo $row_rsinfogendocumentos['doclasedoc_id']; ?>&amp;anio_id=<?php echo $_GET['anio_id']; ?>&amp;hash_id=<?php echo $_GET['hash_id']; ?>&amp;lnk=<?php echo $_GET['lnk']; ?>&amp;numdocumento=<?php echo $_GET['numdocumento']; ?>&amp;almovinddia_id=<?php echo $row_rsfindplaca['almovinddia_id']; ?>" title="Vincular esta placa al comprobante">
                  <?php 
...
?></a>
                  <input type="hidden" name="almovinddia_id" class="id_field" value="<?php echo $row_rsfindplaca['almovinddia_id']; ?>" />
                </td><td><div class="KT_col_midnroplaca"><?php echo KT_FormatForList($row_rsfindplaca['midnroplaca'], 20); ?></div></td>
                <td><div class="KT_col_midnroserie"><?php echo KT_FormatForList($row_rsfindplaca['midnroserie'], 20); ?></div></td>
                <td><div class="KT_col_ca_nomcuenta"><?php echo $row_rsfindplaca['ca_nomcuenta']; ?></div></td>
                ...
                <td align="right"><div class="KT_col_mid_valormovto"><?php echo number_format($row_rsfindplaca['mid_valormovto'],2,',','.'); ?></div></td>
