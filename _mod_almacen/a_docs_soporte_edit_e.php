...
?>
    ...
    <tr>
      <td class="KT_th"><label for="do_nrodoc">Número:</label></td>
      <td><input type="number" name="do_nrodoc" id="do_nrodoc" size="32" />
...
?>
    ...
    <tr>
      <td class="KT_th"><label for="doccnit">Número documento:</label></td>
    ...
    <tr>
      ...
      <td><select name="md_tipomovto" id="md_tipomovto">
        <option value="" <?php if (!(strcmp("", $row_rsalmovtodia['md_tipomovto']))) {echo "selected=\"selected\"";} ?>>Seleccione..</option>
        <?php
do {  
?><option value="<?php echo $row_rstipomov['typemov_code']?>"<?php if (!(strcmp($row_rstipomov['typemov_code'], $row_rsalmovtodia['md_tipomovto']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rstipomov['typemov_name']?></option>
          <?php
...
?>
    ...
    <tr>
      ...
      <td><select name="mdconcepto" id="mdconcepto">
        <option value="" <?php if (!(strcmp("", $row_rsalmovtodia['mdconcepto']))) {echo "selected=\"selected\"";} ?>>Seleccione..</option>
        <?php
do {  
?><option value="<?php echo $row_rsconceptos['co_codconcepto']?>"<?php if (!(strcmp($row_rsconceptos['co_codconcepto'], $row_rsalmovtodia['mdconcepto']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsconceptos['co_nomconcepto']?></option>
          <?php
...
?>
    ...
    <tr>
      ...
      <td><select name="mddependencia" id="mddependencia">
        <option value="" <?php if (!(strcmp("", $row_rsalmovtodia['mddependencia']))) {echo "selected=\"selected\"";} ?>>Seleccione..</option>
        <?php
do {  
?><option value="<?php echo $row_rsdependencias['de_coddep']?>"<?php if (!(strcmp($row_rsdependencias['de_coddep'], $row_rsalmovtodia['mddependencia']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsdependencias['de_nomdep']?></option>
          <?php
