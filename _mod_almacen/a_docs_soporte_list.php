            ...
            <?php do { ?>
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                <td><input type="checkbox" name="kt_pk_q_master_gedocumentos" class="id_checkbox" value="<?php echo $row_rslistdocssoporte['doclasedoc_id']; ?>" />
                    ...
                    <a href="<?php echo $row_rslistdocssoporte['cd_link']; ?>?as_id=<?php echo $_GET['as_id']; ?>&amp;doclasedoc_id=<?php echo $row_rslistdocssoporte['doclasedoc_id']; ?>&amp;anio_id=<?php echo $_GET['anio_id']; ?>&amp;hash_id=<?php echo $_GET['hash_id']; ?>&amp;lnk=<?php echo $row_rslistdocssoporte['doclasedoc']; ?>">
                    <?php 
// Show IF Conditional region4 
if (@$row_rslistdocssoporte['doclasedoc'] == 314 or $row_rslistdocssoporte['doclasedoc'] == 311) {
?>
...
?></a></td>
                ...
                <td><div class="KT_col_doccnit"><?php echo KT_FormatForList($row_rslistdocssoporte['doccnit'], 15); ?></div></td>
                <td><div class="KT_col_do_file"><a href="<?php echo $downloadObj1->getDownloadLink(); ?>"><?php echo $row_rslistdocssoporte['do_file']; ?></a></div></td>
                <td>.</td>
              </tr>
...
<span>&nbsp;</span>
        ...
        <a class="KT_additem_op_link" href="a_docs_soporte_edit.php?as_id=<?php echo $_GET['as_id']; ?>&amp;KT_back=1&amp;anio_id=<?php echo $_GET['anio_id']; ?>" onclick="return nxt_list_additem(this)">Nuevo doc.</a>  <?php } 
