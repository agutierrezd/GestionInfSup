...
<div>
	...
	<ul>
	  <?php do { ?>
      <li><a href="a_movimientos_list_e.php?anio_id=<?php echo $row_rsperiodos['periodo_name']; ?>" title="Seleccionar periodo"><?php echo $row_rsperiodos['periodo_name']; ?></a></li>
	  <?php } while ($row_rsperiodos = mysql_fetch_assoc($rsperiodos)); ?>
    </ul>
</div>
<div class="KT_tng" id="listrslistasientos1">
  <h1> <span class="titlemsg2">EGRESOS</span>
    <?php
            ...
            <?php do { ?>
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                <td><input type="hidden" name="as_id" class="id_field" value="<?php echo $row_rslistasientos['as_id']; ?>" />
                  <a href="a_docs_soporte_list_e.php?as_id=<?php echo $row_rslistasientos['as_id']; ?>&amp;anio_id=<?php echo $_GET['anio_id']; ?>&amp;hash_id=<?php echo md5($row_rslistasientos['as_id']); ?>" title="Ver / Crear movimientos"><img src="325_docs.png" width="32" height="32" border="0" /></a></td>
                ...
                <td><div class="KT_col_as_fechaasiento"><?php echo KT_formatDate($row_rslistasientos['as_fechaasiento']); ?></div></td>
...
?>
        ...
        <a class="KT_additem_op_link" href="a_movimientos_edit_e.php?cod_almacen=<?php echo $row_rslistasientos['ascodalmacen']; ?>&amp;KT_back=1&amp;anio_id=<?php echo $_GET['anio_id']; ?>" onclick="return nxt_list_additem(this)"><?php echo NXT_getResource("add new"); ?></a> <?php } 
