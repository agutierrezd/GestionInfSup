...
$query_rslist = "SELECT * FROM q_hoja_ruta_maestra_info_2017 WHERE {$NXTFilter_rslist} ORDER BY {$NXTSort_rslist} ";
...
?>
                              <td align="center"><a href="hr_history_2017.php?hr_id=<?php echo $row_rslist['hr_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="historial"><img src="icons/326_history.png" width="32" height="32" border="0" /></a></td>
                          <td align="center"><a href="send_hr_2017.php?hr_id=<?php echo $row_rslist['hr_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Realizar acci�n">
...
?><a href="hr_edit_m_2017.php?hr_id=<?php echo $row_rslist['hr_id']; ?>&amp;KT_back=1" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Modificar valor">
...
?><br />
                      ...
                      <td><a href="hr_attach_2017.php?hr_id=<?php echo $row_rslist['hr_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Adjuntar soporte documental"><img src="icons/326_Attach.png" width="32" height="32" border="0" /></a></td>
                    </tr>
...
<span>&nbsp;</span><a href="hr_new_2017.php" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Crear Hoja Ruta">
<?php 
// Show IF Conditional region9 
if (@$_SESSION['kt_login_level'] == 2) {
?>
