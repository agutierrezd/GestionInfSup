...
$formValidation->addField("cont_valorinicial", true, "double", "float_positive", "", "", "");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th"><label for="cont_valorinicial_<?php echo $cnt1; ?>">Valor incial:</label></td>
            <td><input type="text" name="cont_valorinicial_<?php echo $cnt1; ?>" id="cont_valorinicial_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_valorinicial']); ?>" size="10" />
