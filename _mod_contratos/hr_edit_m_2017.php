...
$query_RsInfoHR = sprintf("SELECT * FROM q_hoja_ruta_maestra_2017 WHERE hr_id = %s", GetSQLValueString($colname_RsInfoHR, "int"));
...
$ins_hoja_ruta_2017->addColumn("hr_valor", "DOUBLE_TYPE", "POST", "hr_valor");
...
$upd_hoja_ruta_2017->addColumn("hr_valor", "DOUBLE_TYPE", "POST", "hr_valor");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          ...
          <tr>
            ...
            <td><input type="text" name="hr_valor_<?php echo $cnt1; ?>" id="hr_valor_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rshoja_ruta_2017['hr_valor']); ?>" size="20" />
                <?php echo $tNGs->displayFieldHint("hr_valor");?> <?php echo $tNGs->displayFieldError("hoja_ruta_2017", "hr_valor", $cnt1); ?> </td>
          </tr>
        </table>
