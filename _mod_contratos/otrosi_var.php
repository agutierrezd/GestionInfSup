...
$formValidation->addField("os_varios", true, "text", "", "", "", "");
...
$ins_contrato_os->addColumn("os_varios", "STRING_TYPE", "POST", "os_varios");
...
$upd_contrato_os->addColumn("os_varios", "STRING_TYPE", "POST", "os_varios");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="26%" class="KT_th">&nbsp;</td>
          <td width="74%"><input name="id_cont_fk_<?php echo $cnt1; ?>" type="hidden" id="id_cont_fk_<?php echo $cnt1; ?>" value="<?php echo $_GET['doc_id']; ?>" />
          ...
          <tr>
            <td class="KT_th"><label for="os_varios_<?php echo $cnt1; ?>">Detalle las modificaciones :</label></td>
            <td><textarea name="os_varios_<?php echo $cnt1; ?>" id="os_varios_<?php echo $cnt1; ?>" cols="50" rows="5"><?php echo KT_escapeAttribute($row_rscontrato_os['os_varios']); ?></textarea>
                <?php echo $tNGs->displayFieldHint("os_varios");?> <?php echo $tNGs->displayFieldError("contrato_os", "os_varios", $cnt1); ?> </td>
          </tr>
        </table>
