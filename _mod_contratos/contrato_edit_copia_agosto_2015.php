...
?>
              <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                ...
                <tr>
                  ...
                  <td><input type="text" name="cont_codrubro" id="cont_codrubro" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_codrubro']); ?>" size="32" />
...
?>
                ...
                <tr>
                  ...
                  <td><input type="text" name="numregistro_<?php echo $cnt1; ?>" id="numregistro_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['numregistro']); ?>" size="32" maxlength="80" />
