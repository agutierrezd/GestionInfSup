...
if (isset($_GET['att_type'])) {
  $colname_rscodatt = $_GET['att_type'];
}
mysql_select_db($database_oConnContratos, $oConnContratos);
$query_rscodatt = sprintf("SELECT * FROM contrato_attached_type WHERE id_att_type = %s", GetSQLValueString($colname_rscodatt, "text"));
...
$upd_contrato_attached->registerTrigger("END", "Trigger_Default_Redirect", 99, "ok.php");
        ...
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            ...
            <td width="76%"><input name="id_cont_fk_<?php echo $cnt1; ?>" type="hidden" id="id_cont_fk_<?php echo $cnt1; ?>" value="<?php echo $row_rscodct['id_cont']; ?>" size="7" />
                <?php echo $tNGs->displayFieldHint("id_cont_fk");?> <?php echo $tNGs->displayFieldError("contrato_attached", "id_cont_fk", $cnt1); ?> <input name="att_type_<?php echo $cnt1; ?>" type="hidden" id="att_type_<?php echo $cnt1; ?>" value="<?php echo $row_rscodatt['id_att_type']; ?>" size="2" />
                <?php echo $tNGs->displayFieldHint("att_type");?> <?php echo $tNGs->displayFieldError("contrato_attached", "att_type", $cnt1); ?><span class="titlemsg2"> Adjuntar / Modificar&nbsp;<?php echo $row_rscodatt['att_type_name']; ?></span></td>
          </tr>
