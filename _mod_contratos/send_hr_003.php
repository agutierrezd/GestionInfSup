...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th"></td>
            <td><input name="hr_id_fk_<?php echo $cnt1; ?>" type="hidden" id="hr_id_fk_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfohr['hr_id']; ?>" size="6" />
                <?php echo $tNGs->displayFieldHint("hr_id_fk");?> <?php echo $tNGs->displayFieldError("hoja_ruta_event", "hr_id_fk", $cnt1); ?> <input type="hidden" name="evento_type_<?php echo $cnt1; ?>" id="evento_type_<?php echo $cnt1; ?>" value="4" size="2" />
                <?php echo $tNGs->displayFieldHint("evento_type");?> <?php echo $tNGs->displayFieldError("hoja_ruta_event", "evento_type", $cnt1); ?> <input type="hidden" name="evento_responsable_<?php echo $cnt1; ?>" id="evento_responsable_<?php echo $cnt1; ?>" value="cprieto" size="32" maxlength="40" />
      ...
      if (@$_GET['evento_id'] == "") {
      ?>
            <input type="submit" name="KT_Insert1" id="KT_Insert1" value="Entregar" />
            <?php 
      // else Conditional region1
      } else { ?>
