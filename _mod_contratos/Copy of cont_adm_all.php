              ...
              <table width="422" border="0" cellspacing="2" cellpadding="0">
                ...
                <tr class="frmtablabody">
                  <td ><?php echo $row_rslistpagos['ctrlpagos_fecha']; ?></td>
                    ...
                    <td  align="center"><a href="hr_new_2016A.php?id_cont=<?php echo $_GET['doc_id']; ?>&amp;ctrlpagos_id=<?php echo $row_rslistpagos['ctrlpagos_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Crear Hoja Ruta"><img src="icons/326_pay.png" width="32" height="32" border="0" /></a></td>
                </tr>
