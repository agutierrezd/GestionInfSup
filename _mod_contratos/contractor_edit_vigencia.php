...
$formValidation->addField("cont_fechavigencia", true, "date", "", "", "", "");
$tNGs->prepareValidation($formValidation);
// End trigger

// Make an insert transaction instance
$ins_contrato = new tNG_multipleInsert($conn_oConConfig);
...
$ins_contrato->addColumn("cont_fechavigencia", "DATE_TYPE", "POST", "cont_fechavigencia");
$ins_contrato->setPrimaryKey("id_cont", "NUMERIC_TYPE");

// Make an update transaction instance
$upd_contrato = new tNG_multipleUpdate($conn_oConConfig);
...
$upd_contrato->registerTrigger("END", "Trigger_Default_Redirect", 99, "okm.php");
// Add columns
$upd_contrato->setTable("contrato");
$upd_contrato->addColumn("cont_fechavigencia", "DATE_TYPE", "POST", "cont_fechavigencia");
$upd_contrato->setPrimaryKey("id_cont", "NUMERIC_TYPE", "GET", "id_cont");

// Make an instance of the transaction object
$del_contrato = new tNG_multipleDelete($conn_oConConfig);
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th"><label for="cont_fechavigencia_<?php echo $cnt1; ?>">Vigencia:</label></td>
            <td><input type="text" name="cont_fechavigencia_<?php echo $cnt1; ?>" id="cont_fechavigencia_<?php echo $cnt1; ?>" value="<?php echo KT_formatDate($row_rscontrato['cont_fechavigencia']); ?>" size="10" maxlength="22" wdg:mondayfirst="false" wdg:subtype="Calendar" wdg:mask="<?php echo $KT_screen_date_format; ?>" wdg:type="widget" wdg:singleclick="true" wdg:restricttomask="yes" />
                <?php echo $tNGs->displayFieldHint("cont_fechavigencia");?> <?php echo $tNGs->displayFieldError("contrato", "cont_fechavigencia", $cnt1); ?> </td>
          </tr>
        </table>
