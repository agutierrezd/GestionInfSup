...
$query_rsprenum = "SELECT * FROM contrato_pre WHERE rol = 'GC' ORDER BY codigo ASC";
...
$query_rsrubros = "SELECT DISTINCT(RUBRO), DESCRIPCION FROM q_lista_rubros ORDER BY RUBRO ASC";
...
?>
              <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                ...
                <tr>
                  <td colspan="2" align="center"><input name="cont_codrubro" id="cont_codrubro" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_codrubro']); ?>" size="32" wdg:recordset="rsrubros" wdg:subtype="CommaCheckboxes" required wdg:type="widget" wdg:displayfield="RUBRO" wdg:valuefield="RUBRO" wdg:groupby="10" />
...
?>
                ...
                <tr>
                  ...
                  <td><input name="vrmensual" type="text" id="vrmensual" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_valormensual']); ?>" required pattern="\d+(,\d{2})?" title="No incluir puntos y comas, sino aplica un valor mensual escriba cero(0)" /></td>
                </tr>
                <tr>
