...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th">NÚMERO</td>
            <td><?php echo $row_rshoja_ruta['hr_id']; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input name="hr_fechaingreso_<?php echo $cnt1; ?>" type="text" id="hr_fechaingreso_<?php echo $cnt1; ?>" value="<?php echo $fechac; ?>" size="20" maxlength="22" readonly="true" />
