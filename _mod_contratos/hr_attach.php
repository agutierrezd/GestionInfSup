...
$formValidation->addField("hr_file", true, "", "", "", "", "Adjuntar soporte en PDF.");
...
$ins_hoja_ruta->registerTrigger("AFTER", "Trigger_FileUpload", 97);
// Add columns
$ins_hoja_ruta->setTable("hoja_ruta");
$ins_hoja_ruta->addColumn("hr_file", "FILE_TYPE", "FILES", "hr_file");
...
$upd_hoja_ruta->registerTrigger("AFTER", "Trigger_FileUpload", 97);
// Add columns
$upd_hoja_ruta->setTable("hoja_ruta");
$upd_hoja_ruta->addColumn("hr_file", "FILE_TYPE", "FILES", "hr_file");
...
$del_hoja_ruta->registerTrigger("AFTER", "Trigger_FileDelete", 98);
// Add columns
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th"><label for="hr_file_<?php echo $cnt1; ?>">ADJUNTAR SOPORTE:</label></td>
            <td><input type="file" name="hr_file_<?php echo $cnt1; ?>" id="hr_file_<?php echo $cnt1; ?>" size="32" />
                <?php echo $tNGs->displayFieldError("hoja_ruta", "hr_file", $cnt1); ?> </td>
          </tr>
        </table>
