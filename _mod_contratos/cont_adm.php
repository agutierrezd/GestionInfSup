...
?></td>
  ...
  <tr>
    <td class="titlemsg3Gray"><table width="90%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="32%">Fecha de Inicio</td>
        <td width="29%">Fecha Final</td>
        <td width="16%">Dias contratados</td>
        <td width="11%">Pago mensual</td>
        <td width="12%">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td align="right"><span class="titlemsg2">$<?php echo number_format($row_rsinfocompleta['cont_valormensual'],2,',','.'); ?></span></td>
          ...
          <tr>
            <td width="45%"><table width="500" border="0" cellspacing="3" cellpadding="0">
              <tr>
                ...
                <td width="12%" align="center">&nbsp;</td>
                <td width="10%" align="center" title="Registrar p�liza"><a href="contrato_attached.php?hash=<?php echo md5($row_rsinfocompleta['cont_hash']); ?>&amp;id_cont=<?php echo $row_rsinfocompleta['id_cont']; ?>&amp;att_type=1" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="icons/_488_new.png" width="48" height="48" border="0" /></a></td>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <?php do { ?>
                      <tr class="frmtablabody">
                        ...
                        <td align="center"><a href="contrato_attached_edit.php?hash=<?php echo md5($row_rsinfocompleta['cont_hash']); ?>&amp;id_cont=<?php echo $row_rsinfocompleta['id_cont']; ?>&amp;att_type=1&amp;id_att=<?php echo $row_rsattpoliza['id_att']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Modificar p�liza"><img src="../img_mcit/icon/edit_322_a.png" width="32" height="32" border="0" /></a></td>
