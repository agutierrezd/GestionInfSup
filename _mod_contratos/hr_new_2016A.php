...
$masterValidation->addField("hr_valor", true, "double", "", "", "", "");
...
mysql_select_db($database_oConnContratos, $oConnContratos);
$query_rsctrl = sprintf("SELECT * FROM hoja_ruta_2016 WHERE ctrlpagos_id_fk = %s", GetSQLValueString($colname_rsctrl, "int"));
...
// Add columns
$ins_hoja_ruta->setTable("hoja_ruta_2016");
...
// Add columns
$ins_hoja_ruta_event->setTable("hoja_ruta_event_2016");
...
$rshoja_ruta = $tNGs->getRecordset("hoja_ruta_2016");
...
<?php if ($totalRows_rsctrl == 0) { // Show if recordset empty ?>
  <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
    <table cellpadding="2" cellspacing="0" class="KT_tngtable">
      <tr>
        <td class="KT_th">CONTRATO</td>
        <td><input name="ctrlpagos_id_fk" type="hidden" id="ctrlpagos_id_fk" value="<?php echo $row_rsinfopago['ctrlpagos_id']; ?>" size="32" />
            <?php echo $tNGs->displayFieldHint("ctrlpagos_id_fk");?> <?php echo $tNGs->displayFieldError("hoja_ruta", "ctrlpagos_id_fk"); ?>
            <input name="id_cont_fk" type="hidden" id="id_cont_fk" value="<?php echo $row_rsinfocont['id_cont']; ?>" size="32" />
        ...
        <?php echo $tNGs->displayFieldHint("hr_anio");?> <?php echo $tNGs->displayFieldError("hoja_ruta", "hr_anio"); ?> <span class="titlemsg2"><?php echo $row_rsinfocont['pre_contnumero']; ?><?php echo $row_rsinfocont['contnumero']; ?></span></td>
      </tr>
      <tr>
        <td class="KT_th"><label for="hr_nit_contra_ta">DOCUMENTO:</label></td>
        <td><input name="hr_nit_contra_ta" type="text" id="hr_nit_contra_ta" value="<?php echo $row_rsinfocont['cont_nit_contra_ta']; ?>" size="32" readonly="true" />
      ...
      <tr>
        ...
        <td><input name="hr_asunto" type="text" id="hr_asunto" value="<?php echo $row_rsinfopago['ctrlpagos_desc']; ?>" size="32" readonly="true" />
      ...
      <tr>
        ...
        <td><input type="hidden" name="hr_valor" id="hr_valor" value="<?php echo $row_rsinfopago['ctrlpagos_valor']; ?>" size="32" />
            <?php echo $tNGs->displayFieldHint("hr_valor");?> <?php echo $tNGs->displayFieldError("hoja_ruta", "hr_valor"); ?> <span class="titlemsg2"><?php echo number_format($row_rsinfopago['ctrlpagos_valor'],2,',','.'); ?></span></td>
      </tr>
      <tr class="KT_buttons">
        <td colspan="2"><hr />
        </td>
      ...
      <tr>
        ...
        <td><input type="hidden" name="evento_type" id="evento_type" value="1" size="32" />
            ...
            <input name="evento_fechaa" type="text" id="evento_fechaa" value="<?php echo $row_rsinfopago['ctrlpagos_fecha']; ?>" size="32" readonly="true" />
