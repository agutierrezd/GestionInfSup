...
<div>
	...
	<ul>
    	<li><a href="dashboard.php?anio_id=2020">2020</a></li>
        <li><a href="dashboard.php?anio_id=2019">2019</a></li>
        <li><a href="dashboard.php?anio_id=2018">2018</a></li>
        <li><a href="dashboard.php?anio_id=2017">2017</a></li>
              ...
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                ...
                <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td align="right">$<?php echo number_format($row_rsinfoglobaldash['VALORI'],2,',','.'); ?></td>
                  </tr>
                  <tr>
                    <td>Valor mensual</td>
                    <td align="right"><span class="ui-state-error">$<?php echo number_format($row_rsinfoglobaldash['cont_valormensual'],2,',','.'); ?></span></td>
                  </tr>
                </table>
                </td>
                <td>&nbsp;</td>
