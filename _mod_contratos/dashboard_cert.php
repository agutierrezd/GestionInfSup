        ...
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <thead>
            <tr class="KT_row_order">
              ...
              <th class="KT_sorter KT_col_CERTCUMPLIMIENTO <?php echo $tso_listRsLisCert1->getSortIcon('CERTCUMPLIMIENTO'); ?>" id="CERTCUMPLIMIENTO"> <a href="<?php echo $tso_listRsLisCert1->getSortLink('CERTCUMPLIMIENTO'); ?>">CERTCUMPLIMIENTO</a> </th>
              ...
              <?php do { ?>
                <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                  <td><input type="checkbox" name="kt_pk_q_cert_master" class="id_checkbox" value="<?php echo $row_RsLisCert['cert_id']; ?>" />
                      <input type="hidden" name="cert_id" class="id_field" value="<?php echo $row_RsLisCert['cert_id']; ?>" />                  <a href="#"><img src="icons/326_edit.png" width="32" height="32" border="0" /></a></td>
                  <td><div class="KT_col_ESTADO">
                    <?php 
// Show IF Conditional region4 
if (@$row_RsLisCert['ESTADO'] == 1) {
?>
                        <a href="../_gendraft/htmltodocx/_gen_cert.php?doc_id=<?php echo $row_RsLisCert['id_cont_fk']; ?>&amp;cert_id=<?php echo $row_RsLisCert['cert_id']; ?>"><img src="icons/326_word_2.png" width="32" height="32" border="0" /></a>
                      <?php } 
