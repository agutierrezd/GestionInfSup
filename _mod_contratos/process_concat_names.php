...
$customTransaction->registerTrigger("END", "Trigger_Default_Redirect", 99, "contratistas_list.php");
// Set custom transaction SQL
$customTransaction->setSQL("UPDATE contractor_master SET contractor_nombresfull = CONCAT(contractor_name,' ',contractor_lname)");
// Add columns
