...
function Trigger_SendEmail(&$tNG) {
  ...
  $emailObj->setSubject("Recordatorio Notificacion de pago MinCIT, Radicado: {hr_id_fk}");
  //FromFile method
  $emailObj->setContentFile("hr_not_user_2.html");
  ...
  $emailObj->setAttachmentRenameRule("{RsInfo2.send_file}");
...
$colname_RsInfo2 = "-1";
if (isset($_GET['hr_id'])) {
  $colname_RsInfo2 = $_GET['hr_id'];
}
mysql_select_db($database_oConnContratos, $oConnContratos);
$query_RsInfo2 = sprintf("SELECT * FROM q_hoja_ruta_maestra_info_2015 WHERE hr_id = %s", GetSQLValueString($colname_RsInfo2, "int"));
$RsInfo2 = mysql_query($query_RsInfo2, $oConnContratos) or die(mysql_error());
$row_RsInfo2 = mysql_fetch_assoc($RsInfo2);
$totalRows_RsInfo2 = mysql_num_rows($RsInfo2);
