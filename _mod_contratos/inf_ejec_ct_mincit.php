  ...
  <tr>
    <td>&nbsp;
      <div class="KT_tng" id="listRsInfLey1">
        <h1> INFORME DE EJECUCI&Oacute;N CONTRACTUAL
          <?php
            ...
            <table cellpadding="2" cellspacing="0" class="KT_tngtable">
              <thead>
                <tr class="KT_row_order">
                  ...
                  <th id="AVGEJECUCION" class="KT_sorter KT_col_AVGEJECUCION <?php echo $tso_listRsInfLey1->getSortIcon('AVGEJECUCION'); ?>"> <a href="<?php echo $tso_listRsInfLey1->getSortLink('AVGEJECUCION'); ?>">PORCENTAJE EJECUCI&Oacute;N</a> </th>
                  <th>&nbsp;</th>
                </tr>
                <?php 
