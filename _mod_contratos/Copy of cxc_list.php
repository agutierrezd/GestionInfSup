...
if (tNG_fileExists("../Firma_digital/signed/certfirmados/", "{RsInfoCert.cert_file}")) {
?>
            <a href="cxc_confirm.php?cxc_id=<?php echo $row_RsInfoCert['cxc_id']; ?>&amp;inf_id=<?php echo $row_RsInfoCert['inf_id_fk']; ?>&amp;doc_id=<?php echo $row_RsInfoCert['id_cont_fk']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )">Recibir certificado</a>
            <?php } 
// EndIf File Exists (region2)
?>
            </td>
