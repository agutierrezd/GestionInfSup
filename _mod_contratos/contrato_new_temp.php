...
<?php require_once('../Connections/oConnContratos.php'); ?>
<?php require_once('../Connections/oConnSEP.php'); ?>
...
$formValidation->addField("cont_valormensual", true, "double", "float_positive", "", "", "Ingrese el valor del pago mensual.");
$formValidation->addField("cont_hash", true, "text", "", "", "", "");
$formValidation->addField("cont_estado", true, "numeric", "", "", "", "");
...
$query_rsprenum = sprintf("SELECT * FROM contrato_pre WHERE rol = %s ORDER BY codigo ASC", GetSQLValueString($colname_rsprenum, "text"));
...
mysql_select_db($database_oConnSEP, $oConnSEP);
$query_rsrubros = "SELECT DISTINCT(RUBRO), DESCRIPCION FROM sipi_master_a ORDER BY RUBRO ASC";
$rsrubros = mysql_query($query_rsrubros, $oConnSEP) or die(mysql_error());
...
$ins_contrato->addColumn("cont_valormensual", "DOUBLE_TYPE", "POST", "vrmensual", "");
$ins_contrato->addColumn("cont_hash", "STRING_TYPE", "POST", "cont_hash");
$ins_contrato->addColumn("cont_estado", "NUMERIC_TYPE", "POST", "cont_estado");
...
$upd_contrato->addColumn("cont_estado", "NUMERIC_TYPE", "POST", "cont_estado");
...
?>
              <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                <tr>
                  <td width="23%" class="KT_th"><label for="cont_nit_contra_ta">Contratista:</label></td>
                  <td width="77%"><input name="cont_nit_contra_ta" type="text" id="cont_nit_contra_ta" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_nit_contra_ta']); ?>" size="15" maxlength="15" readonly="true" required title="Selecione el numero de c�dula del contratista" />
                    <?php echo $tNGs->displayFieldHint("cont_nit_contra_ta");?> <?php echo $tNGs->displayFieldError("contrato", "cont_nit_contra_ta", $cnt1); ?> <a href="#" onclick="popup();" title="Vincular registro"><img src="../img_mcit/user_add_322.png" width="32" height="32" border="0" />
                      <input name="cont_hash_<?php echo $cnt1; ?>" type="hidden" id="cont_hash_<?php echo $cnt1; ?>" value="<?php echo $letra.$numero; ?>" />
                      <?php echo $tNGs->displayFieldHint("cont_hash");?> <?php echo $tNGs->displayFieldError("contrato", "cont_hash", $cnt1); ?> 
                      <input name="cont_estado_<?php echo $cnt1; ?>" type="hidden" id="cont_estado_<?php echo $cnt1; ?>" value="1" />
                      <?php echo $tNGs->displayFieldHint("cont_estado");?> <?php echo $tNGs->displayFieldError("contrato", "cont_estado", $cnt1); ?> 
                ...
                <tr>
                  <td class="KT_th"><label for="cont_codrubro">Rubro(s):</label></td>
                  <td><input type="text" name="cont_codrubro" id="cont_codrubro" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_codrubro']); ?>" size="32" required />
                      <?php echo $tNGs->displayFieldHint("cont_codrubro");?> <?php echo $tNGs->displayFieldError("contrato", "cont_codrubro", $cnt1); ?> </td>
                </tr>
                <tr>
                  <td class="KT_th"><label for="prenumero_<?php echo $cnt1; ?>">N�mero CDP:</label></td>
                  <td><input type="text" name="prenumero_<?php echo $cnt1; ?>" id="prenumero_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['prenumero']); ?>" size="32" maxlength="80" required />
...
?>
                ...
                <tr>
                  <td class="KT_th"><label for="numregistro_<?php echo $cnt1; ?>">N�mero Registro Presupuestal:</label></td>
                  <td><input type="text" name="numregistro_<?php echo $cnt1; ?>" id="numregistro_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['numregistro']); ?>" size="32" maxlength="80" required />
                      <?php echo $tNGs->displayFieldHint("numregistro");?> <?php echo $tNGs->displayFieldError("contrato", "numregistro", $cnt1); ?> </td>
                </tr>
                <tr>
                  <td class="KT_th">N�mero de contrato:</td>
...
?>
                      ...
                      N&uacute;mero:
                      <input type="text" name="contnumero_<?php echo $cnt1; ?>" id="contnumero_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['contnumero']); ?>" size="20" maxlength="20" required title="Ingrese el numero del contrato / convenio"  />
Vigencia:
...
?>
                ...
                <tr>
                  <td class="KT_th"><label for="cont_fechaapertura_<?php echo $cnt1; ?>">Fecha de suscripci&oacute;n:</label></td>
                ...
                <tr>
                  ...
                  <td><input type="text" name="cont_valorinicial_<?php echo $cnt1; ?>" id="cont_valorinicial_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_valorinicial']); ?>" size="20" />
                      <?php echo $tNGs->displayFieldHint("cont_valorinicial");?> <?php echo $tNGs->displayFieldError("contrato", "cont_valorinicial", $cnt1); ?> (Escriba s&oacute;lo n&uacute;meros)</td>
                </tr>
                <tr>
                  <td class="KT_th">Pago mensual</td>
                  <td><input name="vrmensual" type="text" id="vrmensual" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_valormensual']); ?>" required pattern="\d+(,\d{2})?" title="No incluir puntos y comas" /></td>
                </tr>
                <tr>
                  <td class="KT_th"><label for="cont_modalidad_<?php echo $cnt1; ?>">Modalidad:</label></td>
