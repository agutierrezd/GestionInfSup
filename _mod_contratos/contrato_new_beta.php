...
?>
              <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                ...
                <tr>
                  <td colspan="2" align="center"><input name="cont_codrubro" id="cont_codrubro" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_codrubro']); ?>" size="32" wdg:recordset="rsrubros" wdg:subtype="CommaCheckboxes" required wdg:type="widget" wdg:displayfield="RUBRO" wdg:valuefield="RUBRO" wdg:groupby="7" />
