...
$query_rslisthr = "SELECT * FROM q_hoja_ruta_maestra_info_2016 WHERE {$NXTFilter_rslisthr} ORDER BY {$NXTSort_rslisthr} ";
          ...
          <?php if ($totalRows_rslisthr > 0) { // Show if recordset not empty ?>
            <?php do { ?>
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                <td><input type="hidden" name="hr_id" class="id_field" value="<?php echo $row_rslisthr['hr_id']; ?>" /><a href="hr_history_2016.php?hr_id=<?php echo $row_rslisthr['hr_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="historial"><img src="icons/326_history.png" width="32" height="32" border="0" /></a></td>
...
?>
                        <td align="center"><a href="hr_not_user_2016.php?hr_id=<?php echo $row_rslisthr['hr_id']; ?>&amp;contractor_doc_id=<?php echo $row_rslisthr['hr_nit_contra_ta']; ?>" title="Notificar al usuario" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="icons/326_send_mail.png" width="32" height="32" border="0" /></a></td>
                      </tr>
                    </table>
                    <?php } 
