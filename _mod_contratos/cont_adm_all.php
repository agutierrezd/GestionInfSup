...
<div>
	...
	<ul>
	  <li><a href="dashboard_all.php?anio_id=<?php echo $ano; ?>" title="Regresa una p�gina atr�s">Regresar</a></li>
	</ul>
</div><br />
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  <tr class="titlemsg3Gray">
    <td >&nbsp;</td>
    <td width="16%" >Valor actual</td>
    <td width="16%" >Valor inicial</td>
    <td width="11%" >Valor pagado</td>
    <td width="9%" >Saldo</td>
  </tr>
  <tr>
          ...
          <tr>
            <td width="45%" valign="top"><table width="500" border="0" cellspacing="3" cellpadding="0">
              ...
              <tr class="frmtablabody">
                <td ><textarea name="textarea" id="textarea" cols="30" rows="3"><?php echo $row_rsinfocompleta['prenumero']; ?></textarea></td>
                <td ><textarea name="textarea2" id="textarea2" cols="30" rows="3"><?php echo $row_rsinfocompleta['numregistro']; ?></textarea></td>
                <td ><textarea name="textarea3" id="textarea3" cols="30" rows="3"><?php echo $row_rsinfocompleta['cont_codrubro']; ?></textarea></td>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <?php do { ?>
                      <tr class="frmtablabody">
                        ...
                        <td align="center"><a href="<?php echo $downloadObj3->getDownloadLink(); ?>" title="Descargar p�liza"><img src="../img_mcit/icon/Attach_322.png" width="32" height="32" border="0" /></a><a href="<?php echo $downloadObj3->getDownloadLink(); ?>"></a></td>
...
?>
                      <img src="../img_mcit/icon/ok_322_a.png" width="32" height="32" border="0" />
                            <?php } 
...
?>
                          <img src="../img_mcit/icon/off_322_b.png" width="32" height="32" border="0" />
                      <?php } 
          ...
          <tr>
            <td width="45%"><table width="500" border="0" cellspacing="3" cellpadding="0">
              <tr>
                ...
                <td width="12%" align="right" >&nbsp;</td>
                <td width="10%" align="right" title="Registrar"><a href="controlpagos_reg.php?hash=<?php echo md5($row_rsinfocompleta['cont_hash']); ?>&amp;id_cont=<?php echo $row_rsinfocompleta['id_cont']; ?>&amp;att_type=1" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Adicionar pago"><img src="icons/_488_new.png" width="48" height="48" border="0" /></a></td>
              ...
              <table width="422" border="0" cellspacing="2" cellpadding="0">
                <tr class="frmtablahead">
                  ...
                  <td width="155">MODIFICAR</td>
                  <td width="155">Hoja Ruta</td>
                </tr>
                <?php do { ?>
                <tr class="frmtablabody">
                  <td ><?php echo $row_rslistpagos['ctrlpagos_fecha']; ?></td>
                    ...
                    <td  align="center"><a href="controlpagos_reg.php?ctrlpagos_id=<?php echo $row_rslistpagos['ctrlpagos_id']; ?>&amp;id_cont=<?php echo $row_rslistpagos['id_cont_fk']; ?>&amp;doc_id=<?php echo $row_rslistpagos['id_cont_fk']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Modificar registro"><img src="../img_mcit/icon/edit_322_a.png" width="32" height="32" border="0" /></a></td>
                    <td  align="center"><a href="hr_new_2017A.php?id_cont=<?php echo $_GET['doc_id']; ?>&amp;ctrlpagos_id=<?php echo $row_rslistpagos['ctrlpagos_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Crear Hoja Ruta"><img src="icons/326_pay.png" width="32" height="32" border="0" /></a></td>
                </tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="73%"><table width="500" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td class="titlemsg2">ACTA DE LIQUIDACI�N</td>
                <td width="12%" align="right" >&nbsp;</td>
                <td width="10%" align="right" title="Registrar">&nbsp;</td>
                <td width="10%" align="right" title="Editar">&nbsp;</td>
              </tr>
