...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="14%" class="KT_th"><label for="cont_otrosi_<?php echo $cnt1; ?>">Activar funciones:</label></td>
            <td width="86%"><input name="cont_otrosi_<?php echo $cnt1; ?>" type="hidden" id="cont_otrosi_<?php echo $cnt1; ?>" value="1" />
      ...
      // else Conditional region1
            ...
            <input type="submit" name="KT_Update1" value="Activar" />
            <?php }
      // endif Conditional region1
      ?>
        </div>
