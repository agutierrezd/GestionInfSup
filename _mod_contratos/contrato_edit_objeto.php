...
$formValidation->addField("cont_objeto", true, "text", "", "", "", "");
...
$upd_contrato->addColumn("cont_objeto", "STRING_TYPE", "POST", "cont_objeto");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <?php 
// Show IF Conditional show_cont_objeto_on_update_only 
if (@$_GET['id_cont'] != "") {
?>
            <tr>
              <td class="KT_th"><label for="cont_objeto_<?php echo $cnt1; ?>">Escriba el objeto del contrato:</label></td>
              <td></td>
            </tr>
            <tr>
              <td colspan="2" class="KT_th"><textarea name="cont_objeto_<?php echo $cnt1; ?>" id="cont_objeto_<?php echo $cnt1; ?>" cols="80" rows="20"><?php echo KT_escapeAttribute($row_rscontrato['cont_objeto']); ?></textarea>
              <?php echo $tNGs->displayFieldHint("cont_objeto");?> <?php echo $tNGs->displayFieldError("contrato", "cont_objeto", $cnt1); ?> </td>
            </tr>
            <?php } 
// endif Conditional show_cont_objeto_on_update_only
?>
        </table>
