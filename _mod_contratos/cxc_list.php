...
$query_RsInfoCert = "SELECT * FROM q_info_certpago WHERE sys_status = 1";
...
if (tNG_fileExists("../Firma_digital/signed/certfirmados/", "{RsInfoCert.cert_file}")) {
?>
            <a href="cxc_confirm.php?cxc_id=<?php echo $row_RsInfoCert['cxc_id']; ?>&amp;inf_id=<?php echo $row_RsInfoCert['inf_id_fk']; ?>&amp;doc_id=<?php echo $row_RsInfoCert['id_cont_fk']; ?>&amp;difuncionario=<?php echo $row_RsInfoCert['cxc_numdoc']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )">Recibir cuenta de cobro</a>
            <?php } 
// EndIf File Exists (region2)
?>
            </td>
