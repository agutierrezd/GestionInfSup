...
?>
                ...
                <tr>
                  ...
                  <td><input type="text" name="numregistro_<?php echo $cnt1; ?>" id="numregistro_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['numregistro']); ?>" size="50" maxlength="200" required />
