...
mysql_select_db($database_oConnContratos, $oConnContratos);
$query_rsctrl = sprintf("SELECT * FROM hoja_ruta_2015 WHERE ctrlpagos_id_fk = %s", GetSQLValueString($colname_rsctrl, "int"));
...
// Add columns
$ins_hoja_ruta->setTable("hoja_ruta_2015");
...
// Add columns
$ins_hoja_ruta_event->setTable("hoja_ruta_event_2015");
...
$rshoja_ruta = $tNGs->getRecordset("hoja_ruta_2015");
