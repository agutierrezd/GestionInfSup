...
$formValidation->addField("cont_valorant", true, "double", "float_positive", "", "", "");
...
$ins_contrato->addColumn("cont_valorant", "DOUBLE_TYPE", "POST", "cont_valorant");
...
$upd_contrato->addColumn("cont_valorant", "DOUBLE_TYPE", "POST", "cont_valorant");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th"><label for="cont_valorant_<?php echo $cnt1; ?>">Valor anterior:</label></td>
            <td><input type="text" name="cont_valorant_<?php echo $cnt1; ?>" id="cont_valorant_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rscontrato['cont_valorant']); ?>" size="7" />
                <?php echo $tNGs->displayFieldHint("cont_valorant");?> <?php echo $tNGs->displayFieldError("contrato", "cont_valorant", $cnt1); ?> </td>
          </tr>
        </table>
