...
$formValidation->addField("cont_otrosi", true, "numeric", "", "", "", "");
...
$ins_contrato->addColumn("cont_otrosi", "NUMERIC_TYPE", "POST", "cont_otrosi");
...
$upd_contrato->addColumn("cont_otrosi", "NUMERIC_TYPE", "POST", "cont_otrosi");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="14%" class="KT_th"><label for="cont_otrosi_<?php echo $cnt1; ?>">Desactivar funciones:</label></td>
            <td width="86%"><input name="cont_otrosi_<?php echo $cnt1; ?>" type="hidden" id="cont_otrosi_<?php echo $cnt1; ?>" value="0" />
                <?php echo $tNGs->displayFieldHint("cont_otrosi");?> <?php echo $tNGs->displayFieldError("contrato", "cont_otrosi", $cnt1); ?> </td>
          </tr>
        </table>
      ...
      // else Conditional region1
            ...
            <input type="submit" name="KT_Update1" value="Desactivar" />
            <?php }
      // endif Conditional region1
      ?>
        </div>
