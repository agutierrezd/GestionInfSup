...
$ins_hoja_ruta_2016->registerTrigger("AFTER", "Trigger_FileUpload", 97);
// Add columns
$ins_hoja_ruta_2016->setTable("hoja_ruta_2016");
$ins_hoja_ruta_2016->addColumn("hr_file", "FILE_TYPE", "FILES", "hr_file");
...
$upd_hoja_ruta_2016->registerTrigger("AFTER", "Trigger_FileUpload", 97);
// Add columns
$upd_hoja_ruta_2016->setTable("hoja_ruta_2016");
$upd_hoja_ruta_2016->addColumn("hr_file", "FILE_TYPE", "FILES", "hr_file");
...
$del_hoja_ruta_2016->registerTrigger("AFTER", "Trigger_FileDelete", 98);
// Add columns
        ...
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            ...
            <td><input type="file" name="hr_file_<?php echo $cnt1; ?>" id="hr_file_<?php echo $cnt1; ?>" size="32" />
                <?php echo $tNGs->displayFieldError("hoja_ruta_2016", "hr_file", $cnt1); ?> </td>
          </tr>
        </table>
