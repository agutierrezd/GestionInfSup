...
?></td>
  ...
  <tr class="titlemsg3Gray">
    <td ><textarea name="textarea" id="textarea" cols="100px" rows="5"><?php echo $row_rsinfocont['cont_objeto']; ?></textarea></td>
    <td width="22%" >Valor del contrato </td>
    <td width="15%" >Valor pagado</td>
    <td width="15%" >Saldo</td>
  </tr>
  <tr>
    <td class="titlemsg3Gray"><table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
...
?>
                          <img src="icons/Date Time_01.png" width="48" height="48" border="0" />
                      <?php } 
// endif Conditional region8
?></a></td>
...
?>
                        <img src="icons/Upload-02-WF.png" width="48" height="48" border="0" />
                        <?php } 
...
?>
                        <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td width="110">&nbsp;</td>
                            <td width="40">&nbsp;</td>
                            <td width="40"><a href="<?php echo $downloadObj2->getDownloadLink(); ?>" title="Descargar documento firmado"><img src="icons/File Lock-WF.png" alt="" width="48" height="48" border="0" /></a></td>
                            <td width="40"><a href="infanexos_list_view.php?inf_id=<?php echo $row_rsinformesreg['inf_id']; ?>&amp;doc_id=<?php echo $row_rsinformesreg['id_cont_fk']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Ver documentos adjuntos al informe"><img src="icons/File Next-WF.png" width="48" height="48" border="0" /></a></td>
                          </tr>
                                                      </table>
                        <?php 
...
?>
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><a href="infanexos_list_view.php?inf_id=<?php echo $row_rsinformesreg['inf_id']; ?>&amp;doc_id=<?php echo $row_rsinformesreg['id_cont_fk']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Ver documentos adjuntos al informe"><img src="icons/Document ZoomIn-WF.png" width="48" height="48" border="0" /></a></td>
                                  </tr>
                                </table>
                        <?php } 
...
?>
                                  <img src="icons/Microsoft-Word-New.png" width="48" height="48" border="0" onclick="MM_popupMsg('A continuaci&oacute;n se genera un documento en formato Word, una vez verificado y corregido guarde el documento como .PDF y s&uacute;balo al sistema para que sea firmado digitalmente por el supervisor.')" />
                                  <?php } 
// endif Conditional region3
?>
                              </a></td>
