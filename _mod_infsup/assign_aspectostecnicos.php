...
$formValidation->addField("inf_otrosaspectostecnicos", true, "text", "", "", "", "");
...
$ins_informe_intersup->addColumn("inf_otrosaspectostecnicos", "STRING_TYPE", "POST", "inf_otrosaspectostecnicos");
...
$upd_informe_intersup->addColumn("inf_otrosaspectostecnicos", "STRING_TYPE", "POST", "inf_otrosaspectostecnicos");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="17%" class="KT_th">OTROS ASPECTOS T&Eacute;CNICOS</td>
            <td width="83%">Otros aspectos que el supervisor / Interventor considere indispensables relatar en el informe<br /> 
            (inconvenientes, soluciones, aspectos positivos que arrojó la ejecución del contrato / convenio,<br /> 
            recomendaciones para futuras contrataciones, informes o solicitudes a la Oficina Asesora Jurídica, etc.).</td>
          </tr>
          <tr>
            <td class="KT_th"><label for="inf_otrosaspectostecnicos_<?php echo $cnt1; ?>"></label></td>
            <td><textarea name="inf_otrosaspectostecnicos_<?php echo $cnt1; ?>" id="inf_otrosaspectostecnicos_<?php echo $cnt1; ?>" cols="70" rows="10"><?php echo KT_escapeAttribute($row_rsinforme_intersup['inf_otrosaspectostecnicos']); ?></textarea>
                <?php echo $tNGs->displayFieldHint("inf_otrosaspectostecnicos");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_otrosaspectostecnicos", $cnt1); ?> </td>
          </tr>
        </table>
