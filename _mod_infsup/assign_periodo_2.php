...
$formValidation->addField("cont_informessug", true, "numeric", "", "", "", "");
...
$ins_contrato->addColumn("cont_informessug", "NUMERIC_TYPE", "POST", "cont_informessug");
...
$upd_contrato->addColumn("cont_informessug", "NUMERIC_TYPE", "POST", "cont_informessug");
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  ...
  <tr>
    <td class="titlemsg2">Periodicidad:</td>
    <td class="titlemsg2"><?php echo $row_rsinfo['periodo_name']; ?></td>
  </tr>
</table>
  <?php
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="25%" class="KT_th"><label for="cont_informessug_<?php echo $cnt1; ?>">Informes sugeridos por el sistema:</label></td>
            <td width="75%"><input type="text" name="cont_informessug_<?php echo $cnt1; ?>" id="cont_informessug_<?php echo $cnt1; ?>" value="<?php echo round(($row_rsinfo['QTYDIAS']/$row_rsinfo['periodo_dias']),0); ?>" size="7" wdg:negatives="no" wdg:subtype="NumericInput" wdg:min="1" wdg:max="99" wdg:type="widget" wdg:floats="yes" wdg:spinner="yes" />
                <?php echo $tNGs->displayFieldHint("cont_informessug");?> <?php echo $tNGs->displayFieldError("contrato", "cont_informessug", $cnt1); ?> </td>
          </tr>
        </table>
