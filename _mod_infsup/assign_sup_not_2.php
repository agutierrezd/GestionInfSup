...
$formValidation->addField("sup_fechanot2", true, "date", "", "", "", "");
$formValidation->addField("sup_mailnot2", true, "text", "", "", "", "");
...
function Trigger_SendEmail(&$tNG) {
  ...
  $emailObj->setTo("{sup_mailnot2}");
  $emailObj->setCC("agutierrezd@mincit.gov.co");
  $emailObj->setBCC("agutierrezd@mincit.gov.co");
  $emailObj->setSubject("Novedad en la supervision al contrato:{rsinfosup.pre_contnumero}{rsinfosup.contnumero} de {rsinfosup.cont_ano}");
  //FromFile method
  $emailObj->setContentFile("send_not_002.html");
...
$ins_interventor_interno->addColumn("sup_fechanot2", "DATE_TYPE", "POST", "sup_fechanot2");
$ins_interventor_interno->addColumn("sup_mailnot2", "STRING_TYPE", "POST", "sup_mailnot2");
...
$upd_interventor_interno->addColumn("sup_fechanot2", "DATE_TYPE", "POST", "sup_fechanot2");
$upd_interventor_interno->addColumn("sup_mailnot2", "STRING_TYPE", "POST", "sup_mailnot2");
...
?>
      Notificar retiro como supervisor
      <?php 
...
// endif Conditional region1
?>
        Al presionar el boton &quot;enviar&quot;, informar&aacute; al supervisor la novedad de retiro como supervisor .
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th">&nbsp;</td>
            <td><input type="hidden" name="sup_status_<?php echo $cnt1; ?>" id="sup_status_<?php echo $cnt1; ?>" value="0" size="0" />
                <?php echo $tNGs->displayFieldHint("sup_status");?> <?php echo $tNGs->displayFieldError("interventor_interno", "sup_status", $cnt1); ?> <input type="hidden" name="sup_fechanot2_<?php echo $cnt1; ?>" id="sup_fechanot2_<?php echo $cnt1; ?>" value="<?php echo $fecha; ?>" size="10" maxlength="22" />
                <?php echo $tNGs->displayFieldHint("sup_fechanot2");?> <?php echo $tNGs->displayFieldError("interventor_interno", "sup_fechanot2", $cnt1); ?> </td>
          </tr>
          
          <tr>
            <td class="KT_th"><label for="sup_mailnot2_<?php echo $cnt1; ?>">Se notificar&aacute; al correo:</label></td>
            <td><input name="sup_mailnot2_<?php echo $cnt1; ?>" type="text" id="sup_mailnot2_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfosup['usr_email']; ?>" size="32" maxlength="100" />
                <?php echo $tNGs->displayFieldHint("sup_mailnot2");?> <?php echo $tNGs->displayFieldError("interventor_interno", "sup_mailnot2", $cnt1); ?> </td>
          </tr>
        </table>
