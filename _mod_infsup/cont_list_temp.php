...
?><a href="_create_cert.php?inf_id=<?php echo $row_rsinformesreg['inf_id']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Generar certificado de recibo a satisfacción">
