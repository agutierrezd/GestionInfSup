...
$formValidation->addField("inf_actividades", true, "text", "", "10", "", "Por favor relacione las actividades desarrolladas.");
...
$ins_informe_intersup->addColumn("inf_actividades", "STRING_TYPE", "POST", "inf_actividades");
...
$upd_informe_intersup->addColumn("inf_actividades", "STRING_TYPE", "POST", "inf_actividades");
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td class="KT_th"><label for="inf_actividades_<?php echo $cnt1; ?>">Actividades desarrolladas:<br /> 
            (Descripción de actividades desarrolladas en el periodo de este informe de conformidad con la cláusula de Obligaciones del Contrato, realizadas tanto por el contratista como por la entidad contratante en el período correspondiente al informe de interventoría o supervisión. </label></td>
          </tr>
          <tr>
            <td class="KT_th"><textarea id="inf_actividades_<?php echo $cnt1; ?>" name="inf_actividades_<?php echo $cnt1; ?>" class="dmxEditor office" style="width:700px;height:400px"><?php echo $row_rsinforme_intersup['inf_actividades']; ?></textarea>
              <script type="text/javascript">
  // <![CDATA[
 jQuery(document).ready(
   function()
     {
       jQuery("#inf_actividades_<?php echo $cnt1; ?>").dmxEditor(
         {"width": 700, "height": 400, "focusOnLoad": true, "uploadProcessor": "php", "skin": "office", "locale": "es", "toolbars": {"Search": {"enabled": false}, "Style": {"enabled": false}}}
       );
     }
 );
  // ]]>
              </script><?php echo $tNGs->displayFieldHint("inf_actividades");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_actividades", $cnt1); ?> </td>
          </tr>
        </table>
