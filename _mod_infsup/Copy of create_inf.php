...
$ins_informe_intersup->registerTrigger("END", "Trigger_Default_Redirect", 99, "ok.php");
// Add columns
...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="15%" class="KT_th">Se va a crear el primer informe</td>
      <td width="85%"><input type="hidden" name="id_cont_fk_<?php echo $cnt1; ?>" id="id_cont_fk_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfocont['id_cont']; ?>" size="7" />
                ...
                <?php echo $tNGs->displayFieldHint("inf_periodicidad");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_periodicidad", $cnt1); ?> <input name="inf_fecharep_i_<?php echo $cnt1; ?>" type="hidden" id="inf_fecharep_i_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfocont['FECHAI']; ?>" size="10" maxlength="22" />
                <?php echo $tNGs->displayFieldHint("inf_fecharep_i");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_fecharep_i", $cnt1); ?> <input name="inf_fecharep_f_<?php echo $cnt1; ?>" type="hidden" id="inf_fecharep_f_<?php echo $cnt1; ?>" value="<?php echo $row_rsfechavence['fechavence']; ?>" size="10" maxlength="22" />
            ...
            <?php echo $tNGs->displayFieldHint("inf_objeto");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_objeto", $cnt1); ?> </td>
          </tr>
          
          <tr>
            <td class="KT_th">&nbsp;</td>
          <td><input name="inf_fechasuscripcion_<?php echo $cnt1; ?>" type="hidden" id="inf_fechasuscripcion_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfocont['cont_fechaapertura']; ?>" size="10" maxlength="22" />
                <?php echo $tNGs->displayFieldHint("inf_fechasuscripcion");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_fechasuscripcion", $cnt1); ?> <input name="inf_fechacont_i_<?php echo $cnt1; ?>" type="hidden" id="inf_fechacont_i_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfocont['FECHAI']; ?>" size="10" maxlength="22" />
                ...
                <?php echo $tNGs->displayFieldHint("inf_plazo");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_plazo", $cnt1); ?> <input name="inf_vigencia_<?php echo $cnt1; ?>" type="hidden" id="inf_vigencia_<?php echo $cnt1; ?>" value="<?php echo $row_rsinfocont['cont_fechavigencia']; ?>" size="32" maxlength="100" />
                ...
                <?php echo $tNGs->displayFieldHint("inf_dependencia");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_dependencia", $cnt1); ?> <input name="inf_avgejecucion_<?php echo $cnt1; ?>" type="hidden" id="inf_avgejecucion_<?php echo $cnt1; ?>" value="<?php echo $_GET['avgadv']; ?>" size="7" />
