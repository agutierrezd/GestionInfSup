...
?>
        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
          <tr>
            <td width="19%" class="KT_th"><label for="inf_avgejecucion_<?php echo $cnt1; ?>">Avance en la ejecuc&iacute;on:</label></td>
            <td width="81%"><input type="text" name="inf_avgejecucion_<?php echo $cnt1; ?>" id="inf_avgejecucion_<?php echo $cnt1; ?>" value="<?php echo KT_escapeAttribute($row_rsinforme_intersup['inf_avgejecucion']); ?>" size="7" />
                <?php echo $tNGs->displayFieldHint("inf_avgejecucion");?> <?php echo $tNGs->displayFieldError("informe_intersup", "inf_avgejecucion", $cnt1); ?> %</td>
          </tr>
          <tr>
            <td class="KT_th">&nbsp;</td>
            <td>Establecer  en porcentaje aproximado cu&aacute;nto est&aacute; ejecutado del contrato</td>
          </tr>
        </table>
