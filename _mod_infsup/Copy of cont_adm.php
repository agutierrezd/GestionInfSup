              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <?php do { ?>
                      <tr class="frmtablabody">
                        ...
                        <td align="center"><a href="../_mod_contratos/amparos_list.php?id_att=<?php echo $row_rsattpoliza['id_att']; ?>&amp;id_cont=<?php echo $row_rsattpoliza['id_cont_fk']; ?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )" title="Ver registros"><img src="../img_mcit/icon/amparos_322.png" width="32" height="32" border="0" /></a></td>
                    </tr>
...
?>
                          <table width="100" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                              <td>&nbsp;</td>
                              <td align="center"><a href="cont_list.php?hash=<?php echo $_GET['hash']; ?>&amp;cod_ver=<?php echo $_GET['cod_ver']; ?>&amp;cont_id=<?php echo $_GET['cont_id']; ?>&amp;anio_id=<?php echo $_GET['anio_id']; ?>&amp;doc_id=<?php echo $_GET['doc_id']; ?>" title="Ver informes registrados"><img src="icons/326_viewinf.png" width="32" height="32" border="0" /></a></td>
                              <td>&nbsp;</td>
                            </tr>
