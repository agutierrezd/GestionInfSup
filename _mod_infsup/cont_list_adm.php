...
<div id="tabs">
	<ul>
      <li><a href="#tabs-1">INFORME DE SUPERVISI�N / INTERVENTOR�A</a></li>
  </ul>
    <div id="tabs-1">
...
?>
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                  <tr class="frmtablahead">
                    <td width="12%" >&nbsp;</td>
                    <td width="11%" >&nbsp;</td>
                    <td colspan="2" align="center">PERIODO REPORTADO</td>
                    <td width="12%" >&nbsp;</td>
                    <td width="32%" >&nbsp;</td>
                  </tr>
                  <tr class="frmtablahead">
                  ...
                  <?php do { ?>
                    <tr class="frmtablabody">
                      ...
                      <td align="center"><?php echo $row_rsinformesreg['inf_fecharep_f']; ?></td>
                      <td align="center"><p>&nbsp;</p>
                        <?php 
