      ...
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        <thead>
          <tr class="KT_row_order">
            ...
            <th class="KT_sorter KT_col_anexo_file <?php echo $tso_listrsinfanexos1->getSortIcon('anexo_file'); ?>" id="anexo_file"> <a href="<?php echo $tso_listrsinfanexos1->getSortLink('anexo_file'); ?>">Adjunto</a> </th>
          </tr>
        </thead>
        <tbody>
          ...
          <?php if ($totalRows_rsinfanexos > 0) { // Show if recordset not empty ?>
            <?php do { ?>
              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                <td><input type="hidden" name="inf_anexo_id" class="id_field" value="<?php echo $row_rsinfanexos['inf_anexo_id']; ?>" />                </td>
                <td><div class="KT_col_anexo_titulo"><?php echo $row_rsinfanexos['anexo_titulo']; ?></div></td>
                <td><div class="KT_col_anexo_file"><a href="<?php echo $downloadObj1->getDownloadLink(); ?>"><?php echo $row_rsinfanexos['anexo_file']; ?></a></div>                  <div class="KT_col_inf_id_fk"></div></td>
              </tr>
