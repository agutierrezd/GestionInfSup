...
// Execute
$downloadObj1->setFolder("../../GestionContratos/_attached/");
...
// Execute
$downloadObj3->setFolder("../../GestionContratos/_attached/");
          ...
          <tr>
            <td width="45%"><table width="500" border="0" cellspacing="3" cellpadding="0">
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <?php do { ?>
                      <tr class="frmtablabody">
                        <td ><?php echo $row_rsattpoliza['cont_num'].'_'.$row_rsattpoliza['att_cod']; ?></td>
            ...
            <td width="38%" valign="top"><table width="500" border="0" cellspacing="3" cellpadding="0">
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="0">
                  ...
                  <tr class="frmtablabody">
                    ...
                    <td><?php echo $row_rsattachcont['CONTRATOID'].'_'.$row_rsattachcont['att_type_cod']; ?></td>
