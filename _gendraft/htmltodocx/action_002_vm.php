...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcept = sprintf("SELECT * FROM q_case_2_concept WHERE solcert_id_fk = %s AND vm2_concept = 1", GetSQLValueString($colname_rsconcept, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepta = sprintf("SELECT * FROM q_case_2_concept WHERE solcert_id_fk = %s AND vm2_concept = 2", GetSQLValueString($colname_rsconcepta, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepte = sprintf("SELECT * FROM q_case_2_concept WHERE solcert_id_fk = %s AND vm2_concept = 3", GetSQLValueString($colname_rsconcepte, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepto = sprintf("SELECT * FROM q_case_2_concept WHERE solcert_id_fk = %s AND vm2_concept = 4", GetSQLValueString($colname_rsconcepto, "text"));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['vm2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['vm2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['vm2_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['vm2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['vm2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['vm2_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['vm2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['vm2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['vm2_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['vm2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['vm2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['vm2_number']));
