...
$texto5a = utf8_encode("<strong>PLAZO DEL CONTRATO:</strong>&nbsp;El plazo de ejecución del presente contrato será de once (".$row_rsinfodash['QTYMESES'].") meses sin exceder el 31 de diciembre de ".$row_rsinfodash['VIGENCIA'].", previo cumplimiento de los requisitos de perfeccionamiento y ejecución.<br />");
