...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcept = sprintf("SELECT * FROM q_case_3_concept WHERE solcert_id_fk = %s AND vm3_concept = 1", GetSQLValueString($colname_rsconcept, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepta = sprintf("SELECT * FROM q_case_3_concept WHERE solcert_id_fk = %s AND vm3_concept = 2", GetSQLValueString($colname_rsconcepta, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepte = sprintf("SELECT * FROM q_case_3_concept WHERE solcert_id_fk = %s AND vm3_concept = 3", GetSQLValueString($colname_rsconcepte, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepto = sprintf("SELECT * FROM q_case_3_concept WHERE solcert_id_fk = %s AND vm3_concept = 4", GetSQLValueString($colname_rsconcepto, "text"));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['vm3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['vm3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['vm3_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['vm3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['vm3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['vm3_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['vm3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['vm3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['vm3_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['vm3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['vm3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['vm3_number']));
