...
$texto3 = utf8_encode("FECHA DEL COMPROBANTE:<strong> ".$row_rsalmovtodia['mdfechadoc']."</strong>       NÚMERO DE COMPROBANTE:<strong> ".$row_rsalmovtodia['mdnrodoc']."</strong><br />");
$texto4 = utf8_encode("ALMACEN AFECTADO:<strong> [".$row_rsalmovtodia['mdalmacen']."] ".$row_rsalmovtodia['ascodalmacen_nombre']."</strong> <br />");
$texto5 = utf8_encode("PROVEEDOR / ENTREGADOR:<strong> [".$row_rsgedocumentos['doccnit']."] ".$row_rsinfousuario['func_nombres']."</strong> <br />");
