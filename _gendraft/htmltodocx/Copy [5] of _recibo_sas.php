...
$texto3 = utf8_encode(" El contratista cumplió a satisfacción de conformidad con las Obligaciones establecidas durante el periodo del ".$row_rsinformesreg['certpay_periodoi']." al ".$row_rsinformesreg['certpay_periodof']."");
...
$html_dom->load('<html><body>'.$texto0.$texto1.$texto2.$texto3.$texto4.$texto5.$texto5a.$texto6.$texto7.$texto8.$texto9.'</body></html>');
//Fin Objeto HTML
