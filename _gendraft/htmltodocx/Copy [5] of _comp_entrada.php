...
$texto2 = utf8_encode("TIPO DE NOVEDAD:<strong> [".$row_rsalmovtodia['mdconcepto']."] ".$row_rsalmovtodia['co_nomconcepto']."</strong><br />");
...
$html_dom->load('<html><body>'.$fechagen.$texto2.$texto3.$texto4.$texto5.$texto6.$texto8.$texto9.$texto10.'</body></html>');
//Fin Objeto HTML
