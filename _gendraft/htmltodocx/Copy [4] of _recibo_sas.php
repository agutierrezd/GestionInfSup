...
$texto2 = utf8_encode("Por medio de la presente certifico que recibí el servicio pactado mediante el Contrato Estatal de Prestación de Servicios Profesionales No. ".$row_rsinformesreg['inf_numerocontrato']." DE ".$row_rsinfodash['VIGENCIA']." suscrito entre La Nación-Ministerio de Comercio, Industria y Turismo y ".$row_rsinformesreg['inf_nombrecontratista']." identificado(a) con ".$row_rsinfosupervisor['contractor_type']." No. ".$row_rsinformesreg['inf_doccontratista'].", cuyo objeto es: - <em>". utf8_encode($row_rsinfodash['cont_objeto']).".</em>");
...
$html_dom2->load('<html><body>'.$texto24.$texto25.$texto26.$notauno.$notados.$texto27.'</body></html>');
