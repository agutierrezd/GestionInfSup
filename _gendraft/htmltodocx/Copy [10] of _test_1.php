...
$texto19 = utf8_encode("GARANTÍAS: <br />");
...
$texto22 = utf8_encode("<strong>ASPECTOS TÉCNICOS</strong> <br />".$row_rsinformesreg['inf_otrosaspectostecnicos']." <br />");
$texto23 = utf8_encode("<strong>RECOMENDACIONES Y OBSERVACIONES PARA EL ORDENADOR DEL GASTO</strong> <br />".$row_rsinformesreg['inf_recomyobserva']." <br />");
...
$styleTablez = array('borderSize'=>6, 'borderColor'=>'006699', 'cellMargin'=>80);
$styleFirstRowz = array('borderBottomSize'=>18, 'borderBottomColor'=>'0000FF', 'bgColor'=>'66BBFF');
...
$html_dom2->load('<html><body>'.$var_infactividades.$texto20.$texto21.$texto22.$texto23.'</body></html>');
