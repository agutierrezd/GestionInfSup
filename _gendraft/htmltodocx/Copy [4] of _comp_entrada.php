...
$texto2 = utf8_encode("TIPO DE NOVEDAD: [".$row_rsalmovtodia['mdconcepto']."] ".$row_rsalmovtodia['co_nomconcepto']." <br />");
$texto3 = utf8_encode("FECHA DEL COMPROBANTE: ".$row_rsalmovtodia['mdfechadoc']." NÚMERO DE COMPROBANTE: ".$row_rsalmovtodia['mdnrodoc']." <br />");
$texto4 = utf8_encode("ALMACEN AFECTADO: [".$row_rsalmovtodia['mdalmacen']."] ".$row_rsalmovtodia['ascodalmacen_nombre']." <br />");
$texto5 = utf8_encode("PROVEEDOR / ENTREGADOR: [".$row_rsgedocumentos['doccnit']."] ".$row_rsgedocumentos['pr_nomproveed']." <br />");
$texto7 = utf8_encode("DIRECCION: ".$row_rsgedocumentos['pr_replegproveed']." TELÉFONO: ".$row_rsgedocumentos['pr_telproveed']." <br />");
$texto8 = utf8_encode("DESCRIPCIÓN: ".$row_rsgedocumentos['do_detalle']." <br />");
$texto9 = utf8_encode("ESTADO DEL DOCUMENTO: ".$row_rsalmovtodia['legal_name']." ");
...
$texto14 = utf8_encode("<br />ALMACENISTA:<strong> FERNANDO MARTINEZ MENDEZ</strong><br />");
...
$table->addCell(2500, $styleCell)->addText('CANT.', $fontStyle);
...
// Add cells
$table->addCell(2500, $styleCellD)->addText('NOMBRE DE CUENTA', $fontStyleD);
$table->addCell(2500, $styleCellD)->addText('CODIGO DE CUENTA', $fontStyleD);
...
// Add cells
$table->addCell(9000, $styleCelly)->addText("TOTAL: ".number_format($total,2,',','.'), $fontStyley);
...
$html_dom2->load('<html><body>'.$texto11.$V->ValorEnLetras($total,"pesos").$texto14.$texto15.'</body></html>');
...
while ($row_rsresumen = mysql_fetch_array($rsresumen)){
	$table->addRow();
	$table->addCell(6000)->addText(utf8_encode($row_rsresumen['ca_nomcuenta']));
	$table->addCell(2500)->addText(utf8_encode($row_rsresumen['QTYELEM']));
}
}
