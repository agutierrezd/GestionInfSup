...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcept = sprintf("SELECT * FROM q_case_3_conceptuf WHERE solcert_id_fk = %s AND ufd3_concept = 1", GetSQLValueString($colname_rsconcept, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepta = sprintf("SELECT * FROM q_case_3_conceptuf WHERE solcert_id_fk = %s AND ufd3_concept = 2", GetSQLValueString($colname_rsconcepta, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepte = sprintf("SELECT * FROM q_case_3_conceptuf WHERE solcert_id_fk = %s AND ufd3_concept = 3", GetSQLValueString($colname_rsconcepte, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepto = sprintf("SELECT * FROM q_case_3_conceptuf WHERE solcert_id_fk = %s AND ufd3_concept = 4", GetSQLValueString($colname_rsconcepto, "text"));
...
$caso2 = utf8_encode("NO Producción Nacional");
$caso3 = utf8_encode("SI Producción Nacional");
...
$texto2 = utf8_encode("Certificación Producción Nacional - Medio Ambiente<br />");
...
$table->addCell(4000, $styleCell)->addText('NUMERO', $fontStyle);
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd3_number']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd3_numeroresol']. ' Fecha: '.$row_rsconcepta['ufd3_fecharesol']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd3_numeroresol']. ' Fecha: '.$row_rsconcepte['ufd3_fecharesol']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd3_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd3_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd3_number']));
