...
$query_rsinformesreg = sprintf("SELECT * FROM informe_intersup_certpago WHERE inf_id_fk = %s", GetSQLValueString($colname_rsinformesreg, "int"));
...
$texto2 = utf8_encode("Por medio de la presente certifico que recibí el servicio, en desarrollo del&nbsp;<strong>".$row_rsinformesreg['certpay_tipocontrato']." No. ".$row_rsinformesreg['certpay_cont']." DE ".$row_rsinformesreg['certpay_anio']."</strong>&nbsp;suscrito entre La Nación-Ministerio de Comercio, Industria y Turismo y <strong>".$row_rsinformesreg['certpay_razonsocial']."</strong>&nbsp;identificado(a) con <strong>".$row_rsinformesreg['certpay_tipodoc']."</strong>&nbsp;No.&nbsp;<strong>".$row_rsinformesreg['certpay_numdoc']."</strong>, cuyo objeto es: - <em>".$row_rsinformesreg['certpay_objeto'].".</em>");
$texto3 = utf8_encode("<br />El contratista cumplió a satisfacción de conformidad con las Obligaciones establecidas durante el periodo del <strong>".$row_rsinformesreg['certpay_periodoi']."</strong> al <strong>".$row_rsinformesreg['certpay_periodof']."</strong>");
...
$html_dom->load('<html><body>'.$texto0.$texto1.$texto2.$texto3.$texto4.$texto5a.$texto6.$texto7.$texto8.$texto9.'</body></html>');
//Fin Objeto HTML
...
header('Content-Disposition: attachment; filename='.$row_rsinformesreg['sign_hash_fk'].'.docx');
