...
mysql_select_db($database_oConnAlmacen, $oConnAlmacen);
$query_rsdocvincsum = sprintf("SELECT * FROM q_almacen_322_bajas_sum WHERE doclasedoc_id_fk = %s", GetSQLValueString($colname_rsdocvincsum, "int"));
...
mysql_select_db($database_oConnAlmacen, $oConnAlmacen);
$query_rsdocvincgroup = sprintf("SELECT * FROM q_almacen_322_bajas_group WHERE doclasedoc_id_fk = %s", GetSQLValueString($colname_rsdocvincgroup, "int"));
...
$query_rsdocvinc = sprintf("SELECT * FROM q_almacen_322_bajas WHERE doclasedoc_id_fk = %s", GetSQLValueString($colname_rsdocvinc, "int"));
...
$texto10 = utf8_encode("  ESTADO DE ELEMENTOS: OBSOLETO <br />");
