...
$html_dom->load('<html><body>'.$texto0.$texto1.$texto2.$texto3.$texto4.$texto5.$texto6.$texto7.$texto8.$texto9.$texto10.$texto12.'</body></html>');
//Fin Objeto HTML
...
$html_dom2->load('<html><body>'.$texto11.$V->ValorEnLetras($total,"pesos").$texto13.'</body></html>');
