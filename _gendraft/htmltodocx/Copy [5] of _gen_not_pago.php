...
$texto4 = utf8_encode("Para dar cumplimiento al Decreto 2674 del 21 de diciembre de 2012 y de conformidad con <strong>".$row_rsinfopay['hrnoypay_sec_1']."</strong>, Hoja de Ruta No. <strong>".$row_rsinfopay['hr_id_fk']."</strong> y Numero de Obligación <strong>".$row_rsinfopay['hrnoypay_obliga_num']."</strong> del <strong>".$row_rsinfopay['fechaobliga']."</strong>, me permito  notificarle que el DIA <strong>".$row_rsinfopay['fechauno']."</strong>, la Dirección del Tesoro Nacional del Ministerio de Hacienda y Crédito Público le ABONARÁ a su <strong>".$row_rsinfocontratista['des_cuenta']."</strong> No. <strong>".$row_rsinfocontratista['bank_cta_number']."</strong> del <strong>".$row_rsinfocontratista['nom_banco']."</strong> una transferencia electrónica por un valor de <strong>".strtoupper($V->ValorEnLetras($num,"pesos"))."</strong>CON  00/100 MCTE ($ <strong>". number_format($row_rsinfopay['hrnoypay_value'],2,',','.')."</strong>).<br />");
$texto6 = utf8_encode("Una vez recibida y confirmada la notificación a su correo electrónico registrado, se entenderá notificado este pago y puede confirmar el abono del giro a su cuenta bancaria respectiva o pedir aclaración del mismo al correo lIara@mincit.gov.co <br />");
...
$html_dom->load('<html><body>'.$texto0.$texto1.$texto2.$texto3.$texto4.$texto6.$texto8.$texto9.'</body></html>');
//Fin Objeto HTML
