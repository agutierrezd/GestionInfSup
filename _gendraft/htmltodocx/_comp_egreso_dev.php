...
$texto1 = utf8_encode("ORDEN DE ENTRADA A ALMACÉN<br /><br />");
...
$texto3 = utf8_encode("FECHA DE LA ORDEN:<strong> ".$row_rsalmovtodia['do_fechadoc']."</strong>       NÚMERO DE ORDEN:<strong> ".$row_rsgedocumentos['do_nrodoc']."</strong><br />");
...
$texto5 = utf8_encode("FUNCIONARIO / CONTRATISTA QUE RECIBE:<strong> [".$row_rsgedocumentos['doccnit']."] ".$row_rsinfousuario['func_nombres']."</strong> <br />");
...
$texto14 = utf8_encode("<br /><br />ALMACENISTA:<strong> HERIBERTO CASTRILL&Oacute;N SANCHEZ</strong><br />");
$texto15 = utf8_encode("C.C. 4979088<br />");
...
$texto17 = utf8_encode("<br /><p align='justify'>Yo, <strong>".$row_rsinfousuario['func_nombres']."</strong>, he recibido de la Superintendencia Nacional de Salud los bienes que se relacionan en el presente documento, los cuales me comprometo a mantener y/o devolver en las mismas condiciones en que los he recibido, salvo el deterioro normal al momento de la toma física de inventarios y/o la terminación de mi relación con esta entidad. En cumplimiento a la Ley 734 de 2002 Título IV Capítulo 2 Artículos 21 y 22. Por lo anterior en caso de pérdida o daño de uno o más bienes me comprometo a restituir el bien por uno de iguales o superiores características.</p><br />");
...
$initial_state = array(
  ...
  'current_style' => array('size' => '9'), // The PHPWord style on the top element - may be inherited by descendent elements.
...
$table->addCell(2500, $styleCell)->addText('SERIE', $fontStyle);
...
while ($row_rsdocvinc = mysql_fetch_array($rsdocvinc)){
	...
	$table->addCell(2500)->addText(utf8_encode($row_rsdocvinc['midnroserie']));
...
$html_dom2->load('<html><body>'.$texto17.$texto14.$texto15.$texto16.'</body></html>');
