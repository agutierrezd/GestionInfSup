...
$query_rsinformesreg = sprintf("SELECT * FROM informe_intersup_global WHERE inf_id_fk = %s", GetSQLValueString($colname_rsinformesreg, "int"));
...
$texto0 = utf8_encode("CODIGO DE VERIFICACION No.: ". $row_rsinformesreg['sign_hash_fk']);
$texto1 = utf8_encode("<br /><br /><strong>EL(LA) SUSCRITO(A) SUPERVISOR(A) DEL CONTRATO ESTATAL DE PRESTACIÓN DE SERVICIOS PROFESIONALES No. </strong>"."<strong>".$row_rsinformesreg['certpay_cont']." DE </strong>"."<strong>".$row_rsinformesreg['certpay_anio']."</strong><br /><br />");
$texto2 = utf8_encode("Por medio de la presente certifico que recibí el servicio, en desarrollo del ".$row_rsinformesreg['certpay_tipocontrato']." No. ".$row_rsinformesreg['certpay_cont']." DE ".$row_rsinformesreg['certpay_anio']." suscrito entre La Nación-Ministerio de Comercio, Industria y Turismo y ".$row_rsinformesreg['certpay_razonsocial']." identificado(a) con ".$row_rsinformesreg['certpay_tipodoc']." No. ".$row_rsinformesreg['certpay_numdoc'].", cuyo objeto es: - <em>".utf8_encode($row_rsinformesreg['certpay_objeto']).".</em>");
$texto3 = utf8_encode("<br />El contratista cumplió a satisfacción de conformidad con las Obligaciones establecidas durante la vigencia del contrato que comprende el periodo del ".$row_rsinformesreg['certpay_periodoi']." al ".$row_rsinformesreg['certpay_periodof']."");
$texto4 = utf8_encode("<br />".$row_rsinformesreg['certpay_obs']."");
$texto5 = utf8_encode("<br />Que teniendo en cuenta lo anterior, el valor total del contrato fue por <strong>".strtoupper($V->ValorEnLetras($num,"PESOS"))."</strong> ($". number_format($row_rsinformesreg['certpay_valor'],2,',','.').") por parte del Ministerio de Comercio, Industria y Turismo.");
...
$texto7 = utf8_encode("<br /><br />".$row_rsinformesreg['sup_name']."");
$texto8 = utf8_encode("<br />".$row_rsinformesreg['sup_cargo']."");
$texto9 = utf8_encode("<br />".$row_rsinformesreg['sup_dep']."");
$notauno = utf8_encode(".");
...
$html_dom->load('<html><body>'.$texto1.$texto2.$texto3.$texto4.$texto5.$texto5a.$texto6.$texto7.$texto8.$texto9.'</body></html>');
//Fin Objeto HTML
...
$table->addCell(4500)->addImage('c.png');
...
$html_dom2->load('<html><body>'.$notauno.'</body></html>');
...
header('Content-Disposition: attachment; filename='.$row_rsinfodash['cont_hash'].'.docx');
