...
$texto4 = utf8_encode("<em>El presente informe se presenta en cumplimiento de lo dispuesto en la Resolución No. 3861 de 2015 Por la cual se adopta el manual de Contratación del Ministerio de Comercio Industria y Turismo y se dictan otras disposiciones.</em>");
...
$texto12a = ($row_rsinfodash['cont_objeto']."<br />");
...
$var_infactividades = ($row_rsinformesreg['inf_actividades']);
