...
$query_RsSetT = "SET lc_time_names = 'es_CO';";
$RsSetT = mysql_query($query_RsSetT, $oConnContratos) or die(mysql_error());
$row_RsSetT = mysql_fetch_assoc($RsSetT);
$totalRows_RsSetT = mysql_num_rows($RsSetT);
...
$texto1 = utf8_encode("<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:11.0pt;line-height:107%'>LA SUSCRITA
COORDINADORA DEL GRUPO DE CONTRATOS DEL MINISTERIO DE COMERCIO, INDUSTRIA Y
TURISMO</span></b></p>");
$texto2 = utf8_encode("<div align='center'><strong>CERTIFICA QUE:</strong></div>");
$texto3 = utf8_encode("<strong>".$row_rsinformesreg['SOLICITANTE']."</strong>&nbsp;suscribió con el Ministerio de Comercio, Industria y Turismo, el siguiente Contrato:<br />");
$texto3a = utf8_encode("<strong>".$row_rsinfodash['nom_tipocontrato']."</strong>&nbsp;No.&nbsp;".$row_rsinfodash['CONTRATOID']."&nbsp;de&nbsp;".$row_rsinfodash['VIGENCIA']."<br /><strong>ENTIDAD CONTRATANTE:</strong>&nbsp;Ministerio de Comercio, Industria y Turismo<br /><strong>NIT:</strong>&nbsp;830.115.297-6<br /><strong>CONTRATISTA:</strong>&nbsp;".$row_rsinfodash['contractor_name']."<br /><strong>IDENTIFICACION:</strong>&nbsp;".$row_rsinfodash['DOCID']."<br />");
$texto4 = "<strong>OBJETO:</strong>&nbsp;".$row_rsinfodash['cont_objeto']."&nbsp;<br />";
$texto5 = utf8_encode("<strong>VALOR DEL CONTRATO:</strong>&nbsp;El valor del presente contrato corresponde a la suma de hasta<strong>&nbsp;".strtoupper($V->ValorEnLetras($num,"PESOS"))."</strong> ($".number_format($row_rsinfodash['VALORI'],2,',','.').")<br />");
$texto5a = utf8_encode("<strong>PLAZO DEL CONTRATO:</strong>&nbsp;El plazo de ejecución del presente contrato será de ".$V->ValorEnLetras($row_rsinfodash['QTYMESES'])."(".$row_rsinfodash['QTYMESES'].") meses sin exceder el 31 de diciembre de ".$row_rsinfodash['VIGENCIA'].", previo cumplimiento de los requisitos de perfeccionamiento y ejecución.<br />");
$texto6 = utf8_encode("<strong>FECHA DE SUSCRIPCIÓN:</strong>&nbsp;".$row_rsinfodash['cont_fechaapertura'].".<br /><strong>FECHA DE INICIACIÓN:</strong>&nbsp;".$row_rsinfodash['FECHAINICIO']."<br /><strong>FECHA DE TERMINACIÓN:</strong>&nbsp;".$row_rsinfodash['FECHAFINAL']."<br /><strong>ESTADO DEL CONTRATO:</strong>&nbsp;".$row_rsinfodash['estado_nombre']."<br />");
$mes=nombremes($mes);
$texto6a = utf8_encode("Esta solicitud se expide a favor del interesado a los ".$V->ValorEnLetras($dia)."(".$dia.") días de ".$mes." de  ".$ano."<br /><br /><br />");
$texto7 = "<strong>CLAUDIA LILIANA MARTINEZ MELO</strong><br />";
$texto8 = "Coordinadora Grupo Contratos";
$texto9 = utf8_encode("Grupo Contratos");
...
$html_dom->load('<html><body>'.$texto0.$texto1.$texto2.$texto3.$texto3a.$texto4.$texto5.$texto5a.$texto6.$texto6a.$texto7.$texto8.'</body></html>');
//Fin Objeto HTML
...
$table->addCell(4500)->addImage('cert.png');
...
$html_dom2->load('<html><body>'.$texto9.'</body></html>');
