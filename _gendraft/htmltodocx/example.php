...
$texto0 = utf8_encode("GRPBN- <br /><br />");
...
$revisayfirma = utf8_encode("Revisa, aprueba y firma: ".$row_rsinfosolicituda['usr_name'].' '.$row_rsinfosolicituda['usr_lname']);
$firmaimagen = '<img src="firmajpg2.jpg"/><br>';
$notauno = utf8_encode("Notas:<br>La impresión en soporte caratular (papel)  es una reproducción del documento original que se encuentra en formato electrónico firmado digitalmente, cuya representación digital goza de plena autenticidad, integridad y no repudio, en cumplimiento de la Ley 527 de 1999 (artículos 6 al 13 y 28) y de la Ley 962 de 2005 (artículo 6)");
$notados = utf8_encode("<br><br>La información consignada es fiel copia de la inscrita en la base de datos de certificaciones de producción nacional en la dirección http://www.vuce.gov.co");
...
$html_dom->load('<html><body>'.$texto0.'<br /><br />'.$trato.'<br />'.$representante.'<br />'.$cargo.'<br /><strong>'.$empresa.'</strong><br />'.$direccion.'<br />'.$ciudad.'<br />'.$telefono.'<br />'.$correo.'<br /><br /><br />'.$texto1.$texto2.$texto3.$texto4.$html.'<br />'.$notatres.'<br />'.$firmadopor.'<br />'.$proyecta.'<br />'.$revisayfirma.'<br />'.$fecharespuesta.$notauno.'<br />'.$notados.'</body></html>');
