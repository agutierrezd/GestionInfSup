...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcept = sprintf("SELECT * FROM q_case_1_conceptuf WHERE solcert_id_fk = %s AND ufd1_concep = 1", GetSQLValueString($colname_rsconcept, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepta = sprintf("SELECT * FROM q_case_1_conceptuf WHERE solcert_id_fk = %s AND ufd1_concep = 2", GetSQLValueString($colname_rsconcepta, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepte = sprintf("SELECT * FROM q_case_1_conceptuf WHERE solcert_id_fk = %s AND ufd1_concep = 3", GetSQLValueString($colname_rsconcepte, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepto = sprintf("SELECT * FROM q_case_1_conceptuf WHERE solcert_id_fk = %s AND ufd1_concep = 4", GetSQLValueString($colname_rsconcepto, "text"));
...
$table->addCell(4000, $styleCell)->addText('NOMBRE', $fontStyle);
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd1_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd1_nombre']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd1_numerores'].' Fecha: '.$row_rsconcept['ufd1_fechares']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd1_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd1_nombre']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd1_numerores'].' Fecha: '.$row_rsconcepta['ufd1_fechares']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd1_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd1_nombre']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd1_numerores'].' Fecha: '.$row_rsconcepte['ufd1_fechares']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd1_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd1_nombre']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd1_numerores'].' Fecha: '.$row_rsconcepto['ufd1_fechares']));
