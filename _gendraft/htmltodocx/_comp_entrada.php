...
$texto0 = utf8_encode("SUPERINTENDENCIA NACIONAL DE SALUD<br /><br />");
...
$texto3 = utf8_encode("FECHA DEL COMPROBANTE:<strong> ".$row_rsgedocumentos['do_fechadoc']."</strong>       NÚMERO DEL COMPROBANTE:<strong> ".$row_rsgedocumentos['do_nrodoc']."</strong><br />");
...
$texto14 = utf8_encode("<br />ALMACENISTA:<strong> HERIBERTO CASTRILL&Oacute;N SANCHEZ</strong>");
...
$table->addCell(4500)->addImage('sns_entrada.png');
