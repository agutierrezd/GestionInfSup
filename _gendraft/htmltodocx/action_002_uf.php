...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcept = sprintf("SELECT * FROM q_case_2_conceptuf WHERE solcert_id_fk = %s AND ufd2_concept = 1", GetSQLValueString($colname_rsconcept, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepta = sprintf("SELECT * FROM q_case_2_conceptuf WHERE solcert_id_fk = %s AND ufd2_concept = 2", GetSQLValueString($colname_rsconcepta, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepte = sprintf("SELECT * FROM q_case_2_conceptuf WHERE solcert_id_fk = %s AND ufd2_concept = 3", GetSQLValueString($colname_rsconcepte, "text"));
...
mysql_select_db($database_oConnCERT, $oConnCERT);
$query_rsconcepto = sprintf("SELECT * FROM q_case_2_conceptuf WHERE solcert_id_fk = %s AND ufd2_concept = 4", GetSQLValueString($colname_rsconcepto, "text"));
...
$caso1 = utf8_encode("NO Producción Nacional, SI Transforma Materia Prima");
$caso2 = utf8_encode("NO Producción Nacional, NO Transforma Materia Prima");
$caso3 = utf8_encode("SI Producción Nacional, SI Transforma Materia Prima");
$caso4 = utf8_encode("SI Producción Nacional, NO Transforma Materia Prima");
?>
<?php
/**
...
$texto2 = utf8_encode("Certificación Producción Nacional - Transformación Materia Prima<br />");
...
$table->addCell(4000, $styleCell)->addText('DESCRIPCION', $fontStyle);
$table->addCell(4000, $styleCell)->addText('RESOLUCION', $fontStyle);
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcept['ufd2_numeroresol'].' fecha: '.$row_rsconcept['ufd2_fecharesol']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepta['ufd2_numeroresol'].' fecha: '.$row_rsconcepta['ufd2_fecharesol']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepte['ufd2_numeroresol'].' fecha: '.$row_rsconcepte['ufd2_fecharesol']));
...
// 	$i++; 
	$table->addRow();
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd2_subpartida']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd2_desc']));
	$table->addCell(4000)->addText(utf8_encode($row_rsconcepto['ufd2_numeroresol'].' fecha: '.$row_rsconcepto['ufd2_fecharesol']));
